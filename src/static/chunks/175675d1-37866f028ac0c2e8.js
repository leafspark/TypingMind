    ...
    41008: function (e, t, r) {
        ...
        var s, o, l, h, m, c, p, u, d, g, f, v, b, y, x, w, k, S, M, z, A, T, B = /([A-Z])/g,
            ...
            N = function e(t) {
                ...
                }, getBaseElem: N, isCharacterBox: function (e) {
                    var t = N(e);
        ...
        class O {
            constructor(e) {
                for (var t in this.displayMode = void 0, this.output = void 0, this.leqno = void 0, this.fleqn = void 0, this.throwOnError = void 0, this.errorColor = void 0, this.macros = void 0, this.minRuleThickness = void 0, this.colorIsTextColor = void 0, this.strict = void 0, this.trust = void 0, this.maxSize = void 0, this.maxExpand = void 0, this.globalGroup = void 0, e = e || {}, R) if (R.hasOwnProperty(t)) {
                    var r = R[t];
            ...
            useStrictBehavior(e, t, r) {
                ...
                return !!a && "ignore" !== a && (!0 === a || "error" === a || ("warn" === a ? "undefined" != typeof console && console.warn("LaTeX-incompatible input and strict mode is set to 'warn': " + t + " [" + e + "]") : "undefined" != typeof console && console.warn("LaTeX-incompatible input and strict mode is set to " + ("unrecognized '" + a + "': " + t) + " [" + e + "]"), !1))
            }
        ...
        var L = [new E(0, 0, !1), new E(1, 0, !0), new E(2, 1, !1), new E(3, 1, !0), new E(4, 2, !1), new E(5, 2, !0), new E(6, 3, !1), new E(7, 3, !0)],
            D = [4, 5, 4, 5, 6, 7, 6, 7], V = [5, 5, 5, 5, 7, 7, 7, 7], P = [2, 3, 4, 5, 6, 7, 6, 7],
            F = [3, 3, 5, 5, 7, 7, 7, 7], G = [1, 1, 3, 3, 5, 5, 7, 7], U = [0, 1, 2, 3, 2, 3, 2, 3],
            Y = {DISPLAY: L[0], TEXT: L[2], SCRIPT: L[4], SCRIPTSCRIPT: L[6]},
            X = [{name: "latin", blocks: [[256, 591], [768, 879]]}, {
                name: "cyrillic",
                blocks: [[1024, 1279]]
        ...
        function er(e, t, r) {
            ...
            var a = e.charCodeAt(0), n = Q[t][a];
            if (!n && e[0] in et && (a = et[e[0]].charCodeAt(0), n = Q[t][a]), !n && "text" === r && _(a) && (n = Q[t][77]), n) return {
                depth: n[0],
                height: n[1],
                italic: n[2],
                skew: n[3],
        ...
        var ea = {},
            en = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]],
            ei = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488], es = function (e, t) {
        ...
        class eo {
            ...
            havingStyle(e) {
                return this.style === e ? this : this.extend({style: e, size: es(this.textSize, e)})
            }
        ...
        var el = {
            ...
            sp: 1 / 65536,
            px: 1.00375
        }, eh = {ex: !0, em: !0, mu: !0}, em = function (e) {
            return "string" != typeof e && (e = e.unit), e in el || e in eh || "ex" === e
        }, ec = function (e, t) {
            var r, a;
            if (e.unit in el) r = el[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier; else if ("mu" === e.unit) r = t.fontMetrics().cssEmPerMu; else {
            ...
            for (var n in r && (t += ' style="' + H.escape(r) + '"'), this.attributes) this.attributes.hasOwnProperty(n) && (t += " " + n + '="' + H.escape(this.attributes[n]) + '"');
            t += ">";
        ...
        class ew {
            constructor(e, t, r, a, n, i, s, o) {
                ...
                var l = function (e) {
                    for (var t = 0; t < X.length; t++) for (var r = X[t], a = 0; a < r.blocks.length; a++) {
                        var n = r.blocks[a];
                        if (e >= n[0] && e <= n[1]) return r.name
                    }
                    return null
                }(this.text.charCodeAt(0));
                l && this.classes.push(l + "_fallback"), /[îïíì]/.test(this.text) && (this.text = ex[this.text])
            }
            ...
            toMarkup() {
                var e = !1, t = "<span";
                this.classes.length && (e = !0, t += ' class="' + H.escape(eu(this.classes)) + '"');
                var r = "";
        ...
        for (var e$ = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", eZ = 0; eZ < e$.length; eZ++) {
            var eK = e$.charAt(eZ);
            eC(eq, eI, eE, eK, eK), eC(eN, eI, eF, eK, eK)
        }
        eC(eq, "ams", eF, "C", "ℂ"), eC(eN, "ams", eF, "C", "ℂ"), eC(eq, "ams", eF, "H", "ℍ"), eC(eN, "ams", eF, "H", "ℍ"), eC(eq, "ams", eF, "N", "ℕ"), eC(eN, "ams", eF, "N", "ℕ"), eC(eq, "ams", eF, "P", "ℙ"), eC(eN, "ams", eF, "P", "ℙ"), eC(eq, "ams", eF, "Q", "ℚ"), eC(eN, "ams", eF, "Q", "ℚ"), eC(eq, "ams", eF, "R", "ℝ"), eC(eN, "ams", eF, "R", "ℝ"), eC(eq, "ams", eF, "Z", "ℤ"), eC(eN, "ams", eF, "Z", "ℤ"), eC(eq, eI, eE, "h", "ℎ"), eC(eN, eI, eE, "h", "ℎ");
        for (var eJ = "", eQ = 0; eQ < e$.length; eQ++) {
            var e0 = e$.charAt(eQ);
            eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56320 + eQ)), eC(eN, eI, eF, e0, eJ), eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56372 + eQ)), eC(eN, eI, eF, e0, eJ), eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56424 + eQ)), eC(eN, eI, eF, e0, eJ), eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56580 + eQ)), eC(eN, eI, eF, e0, eJ), eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56684 + eQ)), eC(eN, eI, eF, e0, eJ), eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56736 + eQ)), eC(eN, eI, eF, e0, eJ), eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56788 + eQ)), eC(eN, eI, eF, e0, eJ), eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56840 + eQ)), eC(eN, eI, eF, e0, eJ), eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56944 + eQ)), eC(eN, eI, eF, e0, eJ), eQ < 26 && (eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56632 + eQ)), eC(eN, eI, eF, e0, eJ), eC(eq, eI, eE, e0, eJ = String.fromCharCode(55349, 56476 + eQ)), eC(eN, eI, eF, e0, eJ))
        }
        eC(eq, eI, eE, "k", eJ = String.fromCharCode(55349, 56668)), eC(eN, eI, eF, "k", eJ);
        for (var e1 = 0; e1 < 10; e1++) {
            var e4 = e1.toString();
            eC(eq, eI, eE, e4, eJ = String.fromCharCode(55349, 57294 + e1)), eC(eN, eI, eF, e4, eJ), eC(eq, eI, eE, e4, eJ = String.fromCharCode(55349, 57314 + e1)), eC(eN, eI, eF, e4, eJ), eC(eq, eI, eE, e4, eJ = String.fromCharCode(55349, 57324 + e1)), eC(eN, eI, eF, e4, eJ), eC(eq, eI, eE, e4, eJ = String.fromCharCode(55349, 57334 + e1)), eC(eN, eI, eF, e4, eJ)
        }
        for (var e5 = "\xd0\xde\xfe", e6 = 0; e6 < e5.length; e6++) {
            var e7 = e5.charAt(e6);
            eC(eq, eI, eE, e7, e7), eC(eN, eI, eF, e7, e7)
        }
        var e3 = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]],
            e8 = [["mathbf", "textbf", "Main-Bold"], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathtt", "texttt", "Typewriter-Regular"]],
            e2 = function (e, t) {
                ...
                return eB[r][e] && eB[r][e].replace && (e = eB[r][e].replace), {value: e, metrics: er(e, t, r)}
            }, te = function (e, t, r, a, n) {
                var i, s = e9(e, t, r), o = s.metrics;
                if (e = s.value, o) {
                    var l = o.italic;
                    ("text" === r || a && "mathit" === a.font) && (l = 0), i = new ew(e, o.height, o.depth, l, o.skew, o.width, n)
                } else "undefined" != typeof console && console.warn("No character metrics " + ("for '" + e + "' in style '" + t) + "' and mode '" + r + "'"), i = new ew(e, 0, 0, 0, 0, 0, n);
                if (a) {
                ...
                return tr(n), n
            }, tn = (e, t, r, a) => new ev(e, t, r, a), ti = function (e) {
                var t = new J(e);
                return tr(t), t
            }, ts = function (e) {
                ...
                fontMap: tl, makeSymbol: te, mathsym: function (e, t, r, a) {
                    return (void 0 === a && (a = []), "boldsymbol" === r.font && e9(e, "Main-Bold", t).metrics) ? te(e, "Main-Bold", t, r, a.concat(["mathbf"])) : "\\" === e || "main" === eB[t][e].font ? te(e, "Main-Regular", t, r, a) : te(e, "AMS-Regular", t, r, a.concat(["amsrm"]))
                }, makeSpan: ta, makeSvgSpan: tn, makeLineSpan: function (e, t, r) {
                    var a = ta([e], [], t);
                    ...
                    return tr(n), n
                }, makeFragment: ti, wrapFragment: function (e, t) {
                    return e instanceof J ? ta([], [e], t) : e
                }, makeVList: function (e, t) {
                    for (var r, {children: a, depth: n} = ts(e), i = 0, s = 0; s < a.length; s++) {
                        var o = a[s];
                        if ("elem" === o.type) {
                            var l = o.elem;
                    ...
                    for (var m = [], c = n, p = n, u = n, d = 0; d < a.length; d++) {
                        ...
                        if ("kern" === g.type) u += g.size; else {
                            var f = g.elem, v = ta(g.wrapperClasses || [], [h, f], void 0, g.wrapperStyle || {});
                    ...
                    var a = e.mode, n = e.text, i = ["mord"], s = "math" === a || "text" === a && t.font,
                        o = s ? t.font : t.fontFamily, l = "", h = "";
                    if (55349 === n.charCodeAt(0) && ([l, h] = e2(n, a)), l.length > 0) return te(n, l, a, t, i.concat(h));
                    if (o) {
                        if ("boldsymbol" === o) {
                            var m, c, p = "textord" !== r && e9(n, "Math-BoldItalic", a).metrics ? {
                                fontName: "Math-BoldItalic",
                                fontClass: "boldsymbol"
                            } : {fontName: "Main-Bold", fontClass: "mathbf"};
                            m = p.fontName, c = [p.fontClass]
                        } else s ? (m = tl[o].fontName, c = [o]) : (m = to(o, t.fontWeight, t.fontShape), c = [o, t.fontWeight, t.fontShape]);
                        if (e9(n, m, a).metrics) return te(n, m, a, t, i.concat(c));
                        if (eG.hasOwnProperty(n) && "Typewriter" === m.slice(0, 10)) {
                            for (var u = [], d = 0; d < n.length; d++) u.push(te(n[d], m, a, t, i.concat(c)));
                            return ti(u)
                        }
                    }
                    if ("mathord" === r) return te(n, "Math-Italic", a, t, i.concat(["mathnormal"]));
                    if ("textord" === r) {
                        var g = eB[a][n] && eB[a][n].font;
                        if ("ams" === g) return te(n, to("amsrm", t.fontWeight, t.fontShape), a, t, i.concat("amsrm", t.fontWeight, t.fontShape));
                        if ("main" === g || !g) return te(n, to("textrm", t.fontWeight, t.fontShape), a, t, i.concat(t.fontWeight, t.fontShape));
                    ...
                    var r = ta(["mspace"], [], t), a = ec(e, t);
                    return r.style.marginRight = ep(a), r
                }, staticSvg: function (e, t) {
                    var [r, a, n] = th[e], i = tn(["overlay"], [new ek([new eS(r)], {
                        width: ep(a),
                        height: ep(n),
                        style: "width:" + ep(a),
                ...
                }, svgData: th, tryCombineChars: e => {
                    for (var t = 0; t < e.length - 1; t++) {
                        var r = e[t], a = e[t + 1];
                        r instanceof ew && a instanceof ew && tt(r, a) && (r.text += a.text, r.height = Math.max(r.height, a.height), r.depth = Math.max(r.depth, a.depth), r.italic = a.italic, e.splice(t + 1, 1), t--)
                    }
                    return e
                }
            }, tc = {number: 3, unit: "mu"}, tp = {number: 4, unit: "mu"}, tu = {number: 5, unit: "mu"}, td = {
                ...
                mpunct: {mord: tc, mop: tc, mrel: tu, mopen: tc, mclose: tc, mpunct: tc, minner: tc},
                minner: {mord: tc, mop: tc, mbin: tp, mrel: tu, mopen: tc, mpunct: tc, minner: tc}
            }, tg = {
                mord: {mop: tc},
                mop: {mord: tc, mop: tc},
                mbin: {},
        ...
        var tw = function (e) {
            ...
            }, tS = tm.makeSpan, tM = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
            tz = ["rightmost", "mrel", "mclose", "mpunct"],
            tA = {display: Y.DISPLAY, text: Y.TEXT, script: Y.SCRIPT, scriptscript: Y.SCRIPTSCRIPT}, tT = {
                mord: "mord",
                mop: "mop",
                mbin: "mbin",
                mrel: "mrel",
                ...
                if (1 === e.length) {
                    var h = e[0];
                    "sizing" === h.type ? l = t.havingSize(h.size) : "styling" === h.type && (l = t.havingStyle(tA[h.style]))
                }
                var m = tS([a[0] || "leftmost"], [], t), c = tS([a[1] || "rightmost"], [], t), p = "root" === r;
                return tC(n, (e, t) => {
                    var r = t.classes[0], a = e.classes[0];
                    "mbin" === r && H.contains(tz, a) ? t.classes[0] = "mord" : "mbin" === a && H.contains(tM, r) && (e.classes[0] = "mord")
                }, {node: m}, c, p), tC(n, (e, t) => {
                    var r = tI(t), a = tI(e), n = r && a ? e.hasClass("mtight") ? tg[r][a] : td[r][a] : null;
                ...
                for (var s = 0; s < t.length; s++) {
                    ...
                    h ? a.node = o : i && o.hasClass("newline") && (a.node = tS(["leftmost"])), a.insertAfter = (n = s, e => {
                        t.splice(n + 1, 0, e), s++
                    })
                }
                n && t.pop()
            }, tq = function (e) {
                return e instanceof J || e instanceof eb || e instanceof ev && e.hasClass("enclosing") ? e : null
            }, tN = function e(t, r) {
                var a = tq(t);
                if (a) {
                    var n = a.children;
        ...
        function tE(e, t) {
            ...
            for (var s = [], o = [], l = 0; l < i.length; l++) if (o.push(i[l]), i[l].hasClass("mbin") || i[l].hasClass("mrel") || i[l].hasClass("allowbreak")) {
                ...
                h || (s.push(tO(o, t)), o = [])
            } else i[l].hasClass("newline") && (o.pop(), o.length > 0 && (s.push(tO(o, t)), o = []), s.push(i[l]));
            o.length > 0 && s.push(tO(o, t)), n ? ((a = tO(tB(n, t, !0))).classes = ["tag"], s.push(a)) : r && s.push(r);
        ...
        var tF = {MathNode: tD, TextNode: tV, SpaceNode: tP, newDocumentFragment: tL}, tG = function (e, t, r) {
            return eB[t][e] && eB[t][e].replace && 55349 !== e.charCodeAt(0) && !(eG.hasOwnProperty(e) && r && (r.fontFamily && "tt" === r.fontFamily.slice(4, 6) || r.font && "tt" === r.font.slice(4, 6))) && (e = eB[t][e].replace), new tF.TextNode(e)
        }, tU = function (e) {
            ...
            var n = e.text;
            return H.contains(["\\imath", "\\jmath"], n) ? null : (eB[a][n] && eB[a][n].replace && (n = eB[a][n].replace), er(n, tm.fontMap[r].fontName, a)) ? tm.fontMap[r].variant : null
        }, tX = function (e, t, r) {
            if (1 === e.length) {
                var a, n = t_(e[0], t);
                return r && n instanceof tD && "mo" === n.type && (n.setAttribute("lspace", "0em"), n.setAttribute("rspace", "0em")), [n]
            }
        ...
        function tj(e, t, r, a, n) {
            var i, s = tX(e, r);
            i = 1 === s.length && s[0] instanceof tD && H.contains(["mrow", "mtable"], s[0].type) ? s[0] : new tF.MathNode("mrow", s);
            var o = new tF.MathNode("annotation", [new tF.TextNode(t)]);
            o.setAttribute("encoding", "application/x-tex");
            var l = new tF.MathNode("semantics", [i, o]), h = new tF.MathNode("math", [l]);
            return h.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"), a && h.setAttribute("display", "block"), tm.makeSpan([n ? "katex" : "katex-mathml"], [h])
        }
        ...
        var t$ = function (e) {
            ...
            if (t.displayMode) {
                var r = ["katex-display"];
                t.leqno && r.push("leqno"), t.fleqn && r.push("fleqn"), e = tm.makeSpan(r, [e])
            }
            return e
        }, tK = function (e, t, r) {
            var a, n = t$(r);
            ...
            if ("html" === r.output) {
                ...
                var s = tj(e, t, n, r.displayMode, !1), o = tE(e, n);
            ...
            encloseSpan: function (e, t, r, a, n) {
                ...
                var t = new tF.MathNode("mo", [new tF.TextNode(tQ[e.replace(/^\\/, "")])]);
                return t.setAttribute("stretchy", "true"), t
            }, svgSpan: function (e, t) {
                var {span: r, minWidth: a, height: n} = function () {
                    var r = 4e5, a = e.label.slice(1);
                    if (H.contains(["widehat", "widecheck", "widetilde", "utilde"], a)) {
                        ...
                        return {span: tm.makeSvgSpan([], [m], t), minWidth: 0, height: s}
                    }
                    var c, p, u = [], d = t0[a], [g, f, v] = d, b = v / 1e3, y = g.length;
                    if (1 === y) c = ["hide-tail"], p = [d[3]]; else if (2 === y) c = ["halfarrow-left", "halfarrow-right"], p = ["xMinYMin", "xMaxYMin"]; else if (3 === y) c = ["brace-left", "brace-center", "brace-right"], p = ["xMinYMin", "xMidYMin", "xMaxYMin"]; else throw Error("Correct katexImagesData or update code here to support\n                    " + y + " children.");
                    for (var x = 0; x < y; x++) {
                    ...
                    return {span: tm.makeSpan(["stretchy"], u, t), minWidth: f, height: b}
                }();
        ...
        var t7 = (e, t) => {
                e && "supsub" === e.type ? (o = (l = t4(e.base, "accent")).base, e.base = o, h = function (e) {
                    if (e instanceof ev) return e;
                    throw Error("Expected span<HtmlDomNode> but got " + String(e) + ".")
                }(tR(e, t)), e.base = l) : o = (l = t4(e, "accent")).base;
                var r = tR(o, t.havingCrampedStyle()), a = l.isShifty && H.isCharacterBox(o), n = 0;
                ...
                if (l.isStretchy) m = t1.svgSpan(l, t), m = tm.makeVList({
                    positionType: "firstBaseline",
                    children: [{type: "elem", elem: r}, {
                        type: "elem",
                        elem: m,
                        wrapperClasses: ["svg-align"],
                        wrapperStyle: n > 0 ? {width: "calc(100% - " + ep(2 * n) + ")", marginLeft: ep(2 * n)} : void 0
                    }]
                }, t); else {
                    "\\vec" === l.label ? (c = tm.staticSvg("vec", t), p = tm.svgData.vec[1]) : ((c = ez(c = tm.makeOrd({
                        mode: l.mode,
                        text: l.label
                    }, t, "textord"))).italic = 0, p = c.width, i && (s += c.depth)), m = tm.makeSpan(["accent-body"], [c]);
                    var o, l, h, m, c, p, u = "\\textcircled" === l.label;
                    u && (m.classes.push("accent-full"), s = r.height);
                    var d = n;
                    u || (d -= p / 2), m.style.left = ep(d), "\\textcircled" === l.label && (m.style.top = ".2em"), m = tm.makeVList({
                        positionType: "firstBaseline",
                ...
                var r = e.isStretchy ? t1.mathMLnode(e.label) : new tF.MathNode("mo", [tG(e.label, e.mode)]),
                    a = new tF.MathNode("mover", [t_(e.base, t), r]);
                return a.setAttribute("accent", "true"), a
            },
            t8 = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(e => "\\" + e).join("|"));
        ty({
            type: "accent",
            names: ["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring", "\\widecheck", "\\widehat", "\\widetilde", "\\overrightarrow", "\\overleftarrow", "\\Overrightarrow", "\\overleftrightarrow", "\\overgroup", "\\overlinesegment", "\\overleftharpoon", "\\overrightharpoon"],
            props: {numArgs: 1},
            handler: (e, t) => {
                var r = tw(t[0]), a = !t8.test(e.funcName),
            ...
            htmlBuilder: (e, t) => {
                var r = tR(e.base, t), a = t1.svgSpan(e, t), n = "\\utilde" === e.label ? .12 : 0, i = tm.makeVList({
                    positionType: "top",
            ...
            mathmlBuilder: (e, t) => {
                var r = t1.mathMLnode(e.label), a = new tF.MathNode("munder", [t_(e.base, t), r]);
        ...
        ty({
            ...
            htmlBuilder(e, t) {
                var r, a, n = t.style, i = t.havingStyle(n.sup()), s = tm.wrapFragment(tR(e.body, i, t), t),
                    o = "\\x" === e.label.slice(0, 2) ? "x" : "cd";
                s.classes.push(o + "-arrow-pad"), e.below && (i = t.havingStyle(n.sub()), (r = tm.wrapFragment(tR(e.below, i, t), t)).classes.push(o + "-arrow-pad"));
                var l = t1.svgSpan(e, t), h = -t.fontMetrics().axisHeight + .5 * l.height,
                ...
                return a.children[0].children[0].children[1].classes.push("svg-align"), tm.makeSpan(["mrel", "x-arrow"], [a], t)
            },
            mathmlBuilder(e, t) {
                var r, a = t1.mathMLnode(e.label);
        ...
        ty({
            ...
            }, htmlBuilder: re, mathmlBuilder: rt
        }), ty({
            type: "pmb", names: ["\\pmb"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                var {parser: r} = e;
                return {type: "pmb", mode: r.mode, mclass: rr(t[0]), body: tk(t[0])}
            }, htmlBuilder(e, t) {
                var r = tB(e.body, t, !0), a = tm.makeSpan([e.mclass], r, t);
                return a.style.textShadow = "0.02em 0.01em 0.04px", a
            }, mathmlBuilder(e, t) {
                var r = tX(e.body, t), a = new tF.MathNode("mstyle", r);
        ...
        var ra = {
                ...
                "|": "\\Vert",
                ".": "no arrow"
            }, rn = () => ({type: "styling", body: [], mode: "math", style: "display"}),
        ...
        ty({
            type: "cdlabel", names: ["\\\\cdleft", "\\\\cdright"], props: {numArgs: 1}, handler(e, t) {
                ...
                var r = t.havingStyle(t.style.sup()), a = tm.wrapFragment(tR(e.label, r, t), t);
            ...
            type: "textord", names: ["\\@char"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                for (var r, {parser: a} = e, n = t4(t[0], "ordgroup").body, s = "", o = 0; o < n.length; o++) s += t4(n[o], "textord").text;
                var l = parseInt(s);
        ...
        var ro = (e, t) => {
            ...
            var r = tX(e.body, t.withColor(e.color)), a = new tF.MathNode("mstyle", r);
        ...
        ty({
            ...
            handler(e, t) {
                var {parser: r} = e, a = t4(t[0], "color-token").color, n = t[1];
            ...
            handler(e, t) {
                var {parser: r, breakOnTokenText: a} = e, n = t4(t[0], "color-token").color;
            ...
            handler(e, t, r) {
                var {parser: a} = e, n = "[" === a.gullet.future().text ? a.parseSizeGroup(!0) : null,
        ...
        ty({
            ...
            handler(e) {
                ...
                t.consumeSpaces();
                var a = t.fetch();
                if (rh[a.text]) return ("\\global" === r || "\\\\globallong" === r) && (a.text = rh[a.text]), t4(t.parseFunction(), "internal");
            ...
            handler(e) {
                ...
                return t && h.unshift(t), ("\\edef" === a || "\\xdef" === a) && (h = r.gullet.expandTokens(h)).reverse(), r.gullet.macros.set(s, {
                    ...
                    numArgs: o,
                    delimiters: l
                }, a === rh[a]), {type: "internal", mode: r.mode}
            }
        }), ty({
            type: "internal",
            names: ["\\let", "\\\\globallet"],
            props: {numArgs: 0, allowedInText: !0, primitive: !0},
            handler(e) {
                var {parser: t, funcName: r} = e, a = rm(t.gullet.popToken());
                t.gullet.consumeSpaces();
                var n = rc(t);
                return rp(t, a, n, "\\\\globallet" === r), {type: "internal", mode: t.mode}
            }
        }), ty({
            type: "internal",
            ...
            props: {numArgs: 0, allowedInText: !0, primitive: !0},
            handler(e) {
                var {parser: t, funcName: r} = e, a = rm(t.gullet.popToken()), n = t.gullet.popToken(),
                    i = t.gullet.popToken();
                return rp(t, a, i, "\\\\globalfuture" === r), t.gullet.pushToken(i), t.gullet.pushToken(n), {
                    type: "internal",
                    mode: t.mode
                }
            }
        ...
        var ru = function (e, t, r) {
                ...
                var n = r.havingBaseStyle(t), i = tm.makeSpan(a.concat(n.sizingClasses(r)), [e], r),
                ...
                var s = tm.makeSymbol(e, "Size" + t + "-Regular", n, a),
                    o = rd(tm.makeSpan(["delimsizing", "size" + t], [s], a), Y.TEXT, a, i);
                return r && rg(o, a, Y.TEXT), o
            }, rb = function (e, t, r) {
                var a;
                return a = "Size1-Regular" === t ? "delim-size1" : "delim-size4", {
                    type: "elem",
                    elem: tm.makeSpan(["delimsizinginner", a], [tm.makeSpan([], [tm.makeSymbol(e, t, r)])])
                }
            }, ry = function (e, t, r) {
                ...
                return i.height = t, i.style.height = ep(t), i.style.width = ep(a), {type: "elem", elem: i}
            }, rx = {type: "kern", size: -.008}, rw = ["|", "\\lvert", "\\rvert", "\\vert"],
            rk = ["\\|", "\\lVert", "\\rVert", "\\Vert"], rS = function (e, t, r, a, n, i) {
                var s, o, l, h, m = "", c = 0;
                s = l = h = e, o = null;
                var p = "Size1-Regular";
                "\\uparrow" === e ? l = h = "⏐" : "\\Uparrow" === e ? l = h = "‖" : "\\downarrow" === e ? s = l = "⏐" : "\\Downarrow" === e ? s = l = "‖" : "\\updownarrow" === e ? (s = "\\uparrow", l = "⏐", h = "\\downarrow") : "\\Updownarrow" === e ? (s = "\\Uparrow", l = "‖", h = "\\Downarrow") : H.contains(rw, e) ? (l = "∣", m = "vert", c = 333) : H.contains(rk, e) ? (l = "∥", m = "doublevert", c = 556) : "[" === e || "\\lbrack" === e ? (s = "⎡", l = "⎢", h = "⎣", p = "Size4-Regular", m = "lbrack", c = 667) : "]" === e || "\\rbrack" === e ? (s = "⎤", l = "⎥", h = "⎦", p = "Size4-Regular", m = "rbrack", c = 667) : "\\lfloor" === e || "⌊" === e ? (l = s = "⎢", h = "⎣", p = "Size4-Regular", m = "lfloor", c = 667) : "\\lceil" === e || "⌈" === e ? (s = "⎡", l = h = "⎢", p = "Size4-Regular", m = "lceil", c = 667) : "\\rfloor" === e || "⌋" === e ? (l = s = "⎥", h = "⎦", p = "Size4-Regular", m = "rfloor", c = 667) : "\\rceil" === e || "⌉" === e ? (s = "⎤", l = h = "⎥", p = "Size4-Regular", m = "rceil", c = 667) : "(" === e || "\\lparen" === e ? (s = "⎛", l = "⎜", h = "⎝", p = "Size4-Regular", m = "lparen", c = 875) : ")" === e || "\\rparen" === e ? (s = "⎞", l = "⎟", h = "⎠", p = "Size4-Regular", m = "rparen", c = 875) : "\\{" === e || "\\lbrace" === e ? (s = "⎧", o = "⎨", h = "⎩", l = "⎪", p = "Size4-Regular") : "\\}" === e || "\\rbrace" === e ? (s = "⎫", o = "⎬", h = "⎭", l = "⎪", p = "Size4-Regular") : "\\lgroup" === e || "⟮" === e ? (s = "⎧", h = "⎩", l = "⎪", p = "Size4-Regular") : "\\rgroup" === e || "⟯" === e ? (s = "⎫", h = "⎭", l = "⎪", p = "Size4-Regular") : "\\lmoustache" === e || "⎰" === e ? (s = "⎧", h = "⎭", l = "⎪", p = "Size4-Regular") : ("\\rmoustache" === e || "⎱" === e) && (s = "⎫", h = "⎩", l = "⎪", p = "Size4-Regular");
                var u = ru(s, p, n), d = u.height + u.depth, g = ru(l, p, n), f = g.height + g.depth, v = ru(h, p, n),
                    b = v.height + v.depth, y = 0, x = 1;
                if (null !== o) {
                    var w = ru(o, p, n);
                    y = w.height + w.depth, x = 2
                }
                var k = d + b + y, S = Math.max(0, Math.ceil((t - k) / (x * f))), M = k + S * x * f,
                    z = a.fontMetrics().axisHeight;
                r && (z *= a.sizeMultiplier);
                var A = M / 2 - z, T = [];
                if (m.length > 0) {
                    var B = Math.round(1e3 * M), C = K(m, Math.round(1e3 * (M - d - b))), q = new eS(m, C),
                        N = (c / 1e3).toFixed(3) + "em", I = (B / 1e3).toFixed(3) + "em",
                        R = new ek([q], {width: N, height: I, viewBox: "0 0 " + c + " " + B}),
                        O = tm.makeSvgSpan([], [R], a);
                    O.height = B / 1e3, O.style.width = N, O.style.height = I, T.push({type: "elem", elem: O})
                } else {
                    if (T.push(rb(h, p, n)), T.push(rx), null === o) T.push(ry(l, M - d - b + .016, a)); else {
                        var E = (M - d - b - y) / 2 + .016;
                        T.push(ry(l, E, a)), T.push(rx), T.push(rb(o, p, n)), T.push(rx), T.push(ry(l, E, a))
                    }
                    T.push(rx), T.push(rb(s, p, n))
                }
                var L = a.havingBaseStyle(Y.TEXT),
                    D = tm.makeVList({positionType: "bottom", positionData: A, children: T}, L);
                return rd(tm.makeSpan(["delimsizing", "mult"], [D], L), Y.TEXT, a, i)
            }, rM = function (e, t, r, a, n) {
                var i = j(e, a, r), s = new ek([new eS(e, i)], {
                    width: "400em",
                    height: ep(t),
            ...
            rz = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"],
            rA = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"],
            rT = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], rB = [0, 1.2, 1.8, 2.4, 3],
            rC = [{type: "small", style: Y.SCRIPTSCRIPT}, {type: "small", style: Y.SCRIPT}, {
                type: "small",
                style: Y.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {type: "large", size: 4}],
            rq = [{type: "small", style: Y.SCRIPTSCRIPT}, {type: "small", style: Y.SCRIPT}, {
                type: "small",
                style: Y.TEXT
            }, {type: "stack"}], rN = [{type: "small", style: Y.SCRIPTSCRIPT}, {type: "small", style: Y.SCRIPT}, {
                type: "small",
                style: Y.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {
                type: "large",
                size: 4
            }, {type: "stack"}], rI = function (e) {
                ...
                for (var n = Math.min(2, 3 - a.style.size), i = n; i < r.length && "stack" !== r[i].type; i++) {
                    var s = ru(e, rI(r[i]), "math"), o = s.height + s.depth;
                    if ("small" === r[i].type && (o *= a.havingBaseStyle(r[i].style).sizeMultiplier), o > t) return r[i]
                }
                return r[r.length - 1]
            }, rR = function (e, t, r, a, n, i) {
                "<" === e || "\\lt" === e || "⟨" === e ? e = "\\langle" : (">" === e || "\\gt" === e || "⟩" === e) && (e = "\\rangle"), s = H.contains(rT, e) ? rC : H.contains(rz, e) ? rN : rq;
                var s, o = rH(e, t, s, a);
                return "small" === o.type ? rf(e, o.style, r, a, n, i) : "large" === o.type ? rv(e, o.size, r, a, n, i) : rS(e, t, r, a, n, i)
            }, rO = {
                sqrtImage: function (e, t) {
                    var r, a, n = t.havingBaseSizing(), i = rH("\\surd", e * n.sizeMultiplier, rN, n), s = n.sizeMultiplier,
                        o = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), l = 0, h = 0, m = 0;
                    return "small" === i.type ? (m = 1e3 + 1e3 * o + 80, e < 1 ? s = 1 : e < 1.4 && (s = .7), l = (1 + o + .08) / s, h = (1 + o) / s, (r = rM("sqrtMain", l, m, o, t)).style.minWidth = "0.853em", a = .833 / s) : "large" === i.type ? (m = 1080 * rB[i.size], h = (rB[i.size] + o) / s, l = (rB[i.size] + o + .08) / s, (r = rM("sqrtSize" + i.size, l, m, o, t)).style.minWidth = "1.02em", a = 1 / s) : (l = e + o + .08, h = e + o, (r = rM("sqrtTall", l, m = Math.floor(1e3 * e + o) + 80, o, t)).style.minWidth = "0.742em", a = 1.056), r.height = h, r.style.height = ep(l), {
                        span: r,
                        advanceWidth: a,
                        ruleWidth: (t.fontMetrics().sqrtRuleThickness + o) * s
                    }
                }, sizedDelim: function (e, t, r, a, n) {
                    if ("<" === e || "\\lt" === e || "⟨" === e ? e = "\\langle" : (">" === e || "\\gt" === e || "⟩" === e) && (e = "\\rangle"), H.contains(rz, e) || H.contains(rT, e)) return rv(e, t, !1, r, a, n);
                    if (H.contains(rA, e)) return rS(e, rB[t], !1, r, a, n);
                    throw new i("Illegal delimiter: '" + e + "'")
                }, sizeToMaxHeight: rB, customSizedDelim: rR, leftRightDelim: function (e, t, r, a, n, i) {
            ...
            rL = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
        ...
        ty({
            ...
            htmlBuilder: (e, t) => "." === e.delim ? tm.makeSpan([e.mclass]) : rO.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
            mathmlBuilder: e => {
                var t = [];
            ...
            type: "leftright-right", names: ["\\right"], props: {numArgs: 1, primitive: !0}, handler: (e, t) => {
                ...
                return {type: "leftright-right", mode: e.parser.mode, delim: rD(t[0], e).text, color: r}
            }
        }), ty({
            type: "leftright", names: ["\\left"], props: {numArgs: 1, primitive: !0}, handler: (e, t) => {
                var r = rD(t[0], e), a = e.parser;
                ++a.leftrightDepth;
                ...
                rV(e);
                for (var r, a, n = tB(e.body, t, !0, ["mopen", "mclose"]), i = 0, s = 0, o = !1, l = 0; l < n.length; l++) n[l].isMiddle ? o = !0 : (i = Math.max(n[l].height, i), s = Math.max(n[l].depth, s));
                if (i *= t.sizeMultiplier, s *= t.sizeMultiplier, r = "." === e.left ? tH(t, ["mopen"]) : rO.leftRightDelim(e.left, i, s, t, e.mode, ["mopen"]), n.unshift(r), o) for (var h = 1; h < n.length; h++) {
                    var m = n[h].isMiddle;
                    m && (n[h] = rO.leftRightDelim(m.delim, i, s, m.options, e.mode, []))
                }
                if ("." === e.right) a = tH(t, ["mclose"]); else {
        ...
        var rP = (e, t) => {
            var r, a, n = tm.wrapFragment(tR(e.body, t), t), i = e.label.slice(1), s = t.sizeMultiplier, o = 0,
                l = H.isCharacterBox(e.body);
            if ("sout" === i) (r = tm.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / s, o = -.5 * t.fontMetrics().xHeight; else if ("phase" === i) {
                var h = ec({number: .6, unit: "pt"}, t), m = ec({number: .35, unit: "ex"}, t);
                s /= t.havingBaseSizing().sizeMultiplier;
                var c = n.height + n.depth + h + m;
                n.style.paddingLeft = ep(c / 2 + h);
                var p = Math.floor(1e3 * c * s),
                    u = new ek([new eS("phase", "M400000 " + p + " H0 L" + p / 2 + " 0 l65 45 L145 " + (p - 80) + " H400000z")], {
                        width: "400em",
                        height: ep(p / 1e3),
                        viewBox: "0 0 400000 " + p,
                        preserveAspectRatio: "xMinYMin slice"
                    });
                (r = tm.makeSvgSpan(["hide-tail"], [u], t)).style.height = ep(c), o = n.depth + h + m
            } else {
                /cancel/.test(i) ? l || n.classes.push("cancel-pad") : "angl" === i ? n.classes.push("anglpad") : n.classes.push("boxpad");
                var d = 0, g = 0, f = 0;
                /box/.test(i) ? (f = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), g = d = t.fontMetrics().fboxsep + ("colorbox" === i ? 0 : f)) : "angl" === i ? (d = 4 * (f = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness)), g = Math.max(0, .25 - n.depth)) : g = d = l ? .2 : 0, r = t1.encloseSpan(n, i, d, g, t), /fbox|boxed|fcolorbox/.test(i) ? (r.style.borderStyle = "solid", r.style.borderWidth = ep(f)) : "angl" === i && .049 !== f && (r.style.borderTopWidth = ep(f), r.style.borderRightWidth = ep(f)), o = n.depth + g, e.backgroundColor && (r.style.backgroundColor = e.backgroundColor, e.borderColor && (r.style.borderColor = e.borderColor))
            }
            if (e.backgroundColor) a = tm.makeVList({
                positionType: "individualShift",
            ...
            return (/cancel/.test(i) && (a.height = n.height, a.depth = n.depth), /cancel/.test(i) && !l) ? tm.makeSpan(["mord", "cancel-lap"], [a], t) : tm.makeSpan(["mord"], [a], t)
        }, rF = (e, t) => {
            var r = 0, a = new tF.MathNode(e.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [t_(e.body, t)]);
            switch (e.label) {
                case"\\cancel":
        ...
        ty({
            ...
            handler(e, t, r) {
                var {parser: a, funcName: n} = e, i = t4(t[0], "color-token").color, s = t[1];
            ...
            handler(e, t, r) {
                var {parser: a, funcName: n} = e, i = t4(t[0], "color-token").color, s = t4(t[1], "color-token").color,
                    o = t[2];
        ...
        function rj(e, t, r) {
            ...
            for (w(), y.push(rX(e)); ;) {
                ...
                if ("&" === M) {
                    ...
                    e.consume();
                    var z = void 0;
                    " " !== e.gullet.future().text && (z = e.parseSizeGroup(!0)), b.push(z ? z.value : null), k(), y.push(rX(e)), f = [], v.push(f), w()
        ...
        var rZ = function (e, t) {
            var r, a, n, s, o = e.body.length, l = e.hLinesBeforeRow, h = 0, m = Array(o), c = [],
                ...
                d = 5 * u;
            e.colSeparationType && "small" === e.colSeparationType && (d = t.havingStyle(Y.SCRIPT).sizeMultiplier / t.sizeMultiplier * .2778);
            var g = "CD" === e.colSeparationType ? ec({number: 3, unit: "ex"}, t) : 12 * u, f = 3 * u,
                v = e.arraystretch * g, b = .7 * v, y = .3 * v, x = 0;

            function w(e) {
                for (var t = 0; t < e.length; ++t) t > 0 && (x += .25), c.push({pos: x, isDashed: e[t]})
            }

            for (w(l[0]), r = 0; r < e.body.length; ++r) {
                var k = e.body[r], S = b, M = y;
            ...
            var C = x / 2 + t.fontMetrics().axisHeight, q = e.cols || [], N = [], I = [];
            if (e.tags && e.tags.some(e => e)) for (r = 0; r < o; ++r) {
                var R = m[r], O = R.pos - C, E = e.tags[r], L = void 0;
                (L = !0 === E ? tm.makeSpan(["eqn-num"], [], t) : !1 === E ? tm.makeSpan([], [], t) : tm.makeSpan([], tB(E, t, !0), t)).depth = R.depth, L.height = R.height, I.push({
                    type: "elem",
                    elem: L,
                    shift: O
                })
            ...
            for (a = 0, s = 0; a < h || s < q.length; ++a, ++s) {
                for (var D = q[s] || {}, V = !0; "separator" === D.type;) {
                    if (V || ((n = tm.makeSpan(["arraycolsep"], [])).style.width = ep(t.fontMetrics().doubleRuleSep), N.push(n)), "|" === D.separator || ":" === D.separator) {
                ...
                if (!(a >= h)) {
                    var U = void 0;
                    (a > 0 || e.hskipBeforeAndAfter) && 0 !== (U = H.deflt(D.pregap, d)) && ((n = tm.makeSpan(["arraycolsep"], [])).style.width = ep(U), N.push(n));
                    var X = [];
                    for (r = 0; r < o; ++r) {
                        var W = m[r], _ = W[a];
                        if (_) {
                    ...
                    X = tm.makeVList({
                        positionType: "individualShift",
                        children: X
                    }, t), X = tm.makeSpan(["col-align-" + (D.align || "c")], [X]), N.push(X), (a < h - 1 || e.hskipBeforeAndAfter) && 0 !== (U = H.deflt(D.postgap, d)) && ((n = tm.makeSpan(["arraycolsep"], [])).style.width = ep(U), N.push(n))
                }
            }
            if (m = tm.makeSpan(["mtable"], N), c.length > 0) {
                for (var $ = tm.makeLineSpan("hline", t, p), Z = tm.makeLineSpan("hdashline", t, p), K = [{
                    type: "elem",
                    elem: m,
                    shift: 0
                }]; c.length > 0;) {
                    var J = c.pop(), Q = J.pos - C;
                    J.isDashed ? K.push({type: "elem", elem: Z, shift: Q}) : K.push({type: "elem", elem: $, shift: Q})
                }
                m = tm.makeVList({positionType: "individualShift", children: K}, t)
            }
            if (0 === I.length) return tm.makeSpan(["mord"], [m], t);
            var ee = tm.makeVList({positionType: "individualShift", children: I}, t);
            ...
            for (var r = [], a = new tF.MathNode("mtd", [], ["mtr-glue"]), n = new tF.MathNode("mtd", [], ["mml-eqn-num"]), i = 0; i < e.body.length; i++) {
                for (var s = e.body[i], o = [], l = 0; l < s.length; l++) o.push(new tF.MathNode("mtd", [t_(s[l], t)]));
            ...
            if (t[0] && "ordgroup" === t[0].type) {
                for (var m = "", c = 0; c < t[0].body.length; c++) m += t4(t[0].body[c], "textord").text;
                l = 2 * (r = Number(m))
            }
            var p = !l;
        ...
        rU({
            type: "array", names: ["array", "darray"], props: {numArgs: 1}, handler(e, t) {
                var r = (t6(t[0]) ? [t[0]] : t4(t[0], "ordgroup").body).map(function (e) {
                    var t = t5(e).text;
            ...
            handler(e) {
                ...
                var s = rj(e.parser, a, r$(e.envName)), o = Math.max(0, ...s.body.map(e => e.length));
            ...
            type: "array", names: ["smallmatrix"], props: {numArgs: 0}, handler(e) {
                var t = rj(e.parser, {arraystretch: .5}, "script");
            ...
            type: "array", names: ["CD"], props: {numArgs: 0}, handler: e => (rW(e), function (e) {
                var t = [];
                ...
                for (var a = [], n = [a], s = 0; s < t.length; s++) {
                    for (var o = t[s], l = rn(), h = 0; h < o.length; h++) if (ri(o[h])) {
                        a.push(l);
                        var m = t5(o[h += 1]).text, c = [, ,];
                        if (c[0] = {type: "ordgroup", mode: "math", body: []}, c[1] = {
                            ...
                            for (var u = !0, d = h + 1; d < o.length; d++) {
                                ...
                                if (ri(o[d])) throw new i("Missing a " + m + " character to complete a CD arrow.", o[d]);
                                c[p].body.push(o[d])
                            }
            ...
            handler(e, t) {
                ...
                for (var s = "", o = 0; o < n.body.length; ++o) s += t4(n.body[o], "textord").text;
                if ("\\begin" === a) {
                    if (!rG.hasOwnProperty(s)) throw new i("No such environment: " + s, n);
                    var l = rG[s], {args: h, optArgs: m} = r.parseArguments("\\begin{" + s + "}", l),
                        c = {mode: r.mode, envName: s, parser: r}, p = l.handler(c, h, m);
                    r.expect("\\end", !1);
                    var u = r.nextToken, d = t4(r.parseFunction(), "environment");
        ...
        var r0 = (e, t) => {
            ...
            var r = e.font, a = t.withFont(r);
            return t_(e.body, a)
        }, r4 = {"\\Bbb": "\\mathbb", "\\bold": "\\mathbf", "\\frak": "\\mathfrak", "\\bm": "\\boldsymbol"};
        ty({
            type: "font",
            ...
            handler: (e, t) => {
                var {parser: r, funcName: a} = e, n = tw(t[0]), i = a;
                return i in r4 && (i = r4[i]), {type: "font", mode: r.mode, font: i.slice(1), body: n}
            },
            htmlBuilder: r0,
            mathmlBuilder: r1
        }), ty({
            type: "mclass", names: ["\\boldsymbol", "\\bm"], props: {numArgs: 1}, handler: (e, t) => {
                var {parser: r} = e, a = t[0], n = H.isCharacterBox(a);
                return {
                    type: "mclass",
                    mode: r.mode,
                    mclass: rr(a),
        ...
        var r5 = (e, t) => {
            ...
            var r, a, n, i, s, o, l, h, m, c, p, u = r5(e.size, t.style), d = u.fracNum(), g = u.fracDen();
            r = t.havingStyle(d);
            ...
            if (e.hasBarLine ? (e.barSize ? (n = ec(e.barSize, t), a = tm.makeLineSpan("frac-line", t, n)) : a = tm.makeLineSpan("frac-line", t), n = a.height, i = a.height) : (a = null, n = 0, i = t.fontMetrics().defaultRuleThickness), u.size === Y.DISPLAY.size || "display" === e.size ? (s = t.fontMetrics().num1, o = n > 0 ? 3 * i : 7 * i, l = t.fontMetrics().denom1) : (n > 0 ? (s = t.fontMetrics().num2, o = i) : (s = t.fontMetrics().num3, o = 3 * i), l = t.fontMetrics().denom2), a) {
                ...
                k < o && (s += .5 * (o - k), l += .5 * (o - k)), h = tm.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: y, shift: l}, {type: "elem", elem: f, shift: -s}]
                }, t)
            }
            return r = t.havingStyle(u), h.height *= r.sizeMultiplier / t.sizeMultiplier, h.depth *= r.sizeMultiplier / t.sizeMultiplier, m = u.size === Y.DISPLAY.size ? t.fontMetrics().delim1 : u.size === Y.SCRIPTSCRIPT.size ? t.havingStyle(Y.SCRIPT).fontMetrics().delim2 : t.fontMetrics().delim2, c = null == e.leftDelim ? tH(t, ["mopen"]) : rO.customSizedDelim(e.leftDelim, m, !0, t.havingStyle(u), e.mode, ["mopen"]), p = e.continued ? tm.makeSpan([]) : null == e.rightDelim ? tH(t, ["mclose"]) : rO.customSizedDelim(e.rightDelim, m, !0, t.havingStyle(u), e.mode, ["mclose"]), tm.makeSpan(["mord"].concat(r.sizingClasses(t)), [c, tm.makeSpan(["mfrac"], [h]), p], t)
        }, r7 = (e, t) => {
        ...
        var r3 = ["display", "text", "script", "scriptscript"], r8 = function (e) {
            var t = null;
        ...
        ty({
            ...
            handler(e, t) {
                var r, {parser: a} = e, n = t[4], i = t[5], s = tw(t[0]),
                    o = "atom" === s.type && "open" === s.family ? r8(s.text) : null, l = tw(t[1]),
                    h = "atom" === l.type && "close" === l.family ? r8(l.text) : null, m = t4(t[2], "size"), c = null;
                r = !!m.isBlank || (c = m.value).number > 0;
                var p = "auto", u = t[3];
                return "ordgroup" === u.type ? u.body.length > 0 && (p = r3[Number(t4(u.body[0], "textord").text)]) : p = r3[Number((u = t4(u, "textord")).text)], {
                    type: "genfrac",
                    mode: a.mode,
                    numer: n,
                    denom: i,
            ...
            handler: (e, t) => {
                var {parser: r, funcName: a} = e, n = t[0], i = I(t4(t[1], "infix").size), s = t[2], o = i.number > 0;
                return {
                    type: "genfrac",
                    mode: r.mode,
                    numer: n,
        ...
        var r2 = (e, t) => {
            var r, a, n, i = t.style;
            "supsub" === e.type ? (r = e.sup ? tR(e.sup, t.havingStyle(i.sup()), t) : tR(e.sub, t.havingStyle(i.sub()), t), a = t4(e.base, "horizBrace")) : a = t4(e, "horizBrace");
            var s = tR(a.base, t.havingBaseStyle(Y.DISPLAY)), o = t1.svgSpan(a, t);
            if (a.isOver ? (n = tm.makeVList({
                positionType: "firstBaseline",
                children: [{type: "elem", elem: s}, {type: "kern", size: .1}, {type: "elem", elem: o}]
            }, t)).children[0].children[0].children[1].classes.push("svg-align") : (n = tm.makeVList({
                positionType: "bottom",
        ...
        ty({
            ...
            }, htmlBuilder: r2, mathmlBuilder: (e, t) => {
                var r = t1.mathMLnode(e.label);
                return new tF.MathNode(e.isOver ? "mover" : "munder", [t_(e.base, t), r])
            }
        }), ty({
            type: "href",
            names: ["\\href"],
            ...
            handler: (e, t) => {
                var {parser: r} = e, a = t[1], n = t4(t[0], "url").url;
            ...
            mathmlBuilder: (e, t) => {
                var r = tW(e.body, t);
                return r instanceof tD || (r = new tD("mrow", [r])), r.setAttribute("href", e.href), r
            }
        }), ty({
            type: "href",
            names: ["\\url"],
            ...
            handler: (e, t) => {
                var {parser: r} = e, a = t4(t[0], "url").url;
            ...
            handler: (e, t) => {
                var r, {parser: a, funcName: n, token: s} = e, o = t4(t[0], "raw").string, l = t[1];
            ...
            htmlBuilder: (e, t) => {
                var r = tB(e.body, t, !1), a = ["enclosing"];
            ...
            handler: (e, t) => {
                var {parser: r} = e;
                return {type: "htmlmathml", mode: r.mode, html: tk(t[0]), mathml: tk(t[1])}
            },
            htmlBuilder: (e, t) => {
                var r = tB(e.html, t, !1);
                return tm.makeFragment(r)
        ...
        ty({
            ...
            handler: (e, t, r) => {
                ...
                if (r[0]) for (var h = t4(r[0], "raw").string.split(","), m = 0; m < h.length; m++) {
                    var c = h[m].split("=");
                    if (2 === c.length) {
                        var p = c[1].trim();
                        switch (c[0].trim()) {
            ...
            handler(e, t) {
                var {parser: r, funcName: a} = e, n = t4(t[0], "size");
            ...
            htmlBuilder: (e, t) => {
                "clap" === e.alignment ? (r = tm.makeSpan([], [tR(e.body, t)]), r = tm.makeSpan(["inner"], [r], t)) : r = tm.makeSpan(["inner"], [tR(e.body, t)]);
                var r, a = tm.makeSpan(["fix"], []), n = tm.makeSpan([e.alignment], [r, a], t),
                    i = tm.makeSpan(["strut"]);
                return i.style.height = ep(n.height + n.depth), n.depth && (i.style.verticalAlign = ep(-n.depth)), n.children.unshift(i), n = tm.makeSpan(["thinbox"], [n], t), tm.makeSpan(["mord", "vbox"], [n], t)
            },
            mathmlBuilder: (e, t) => {
        ...
        var at = (e, t, r, a, n, i, s) => {
            ...
            var r, a, n, i, s = !1;
            "supsub" === e.type ? (r = e.sup, a = e.sub, n = t4(e.base, "op"), s = !0) : n = t4(e, "op");
            var o = t.style, l = !1;
            if (o.size === Y.DISPLAY.size && n.symbol && !H.contains(ar, n.name) && (l = !0), n.symbol) {
                var h = l ? "Size2-Regular" : "Size1-Regular", m = "";
                if (("\\oiint" === n.name || "\\oiiint" === n.name) && (m = n.name.slice(1), n.name = "oiint" === m ? "\\iint" : "\\iiint"), i = tm.makeSymbol(n.name, h, "math", t, ["mop", "op-symbol", l ? "large-op" : "small-op"]), m.length > 0) {
                    var c = i.italic, p = tm.staticSvg(m + "Size" + (l ? "2" : "1"), t);
                    i = tm.makeVList({
                        positionType: "individualShift",
                ...
                var u = tB(n.body, t, !0);
                1 === u.length && u[0] instanceof ew ? (i = u[0]).classes[0] = "mop" : i = tm.makeSpan(["mop"], u, t)
            } else {
                for (var d = [], g = 1; g < n.name.length; g++) d.push(tm.mathsym(n.name[g], n.mode, t));
                i = tm.makeSpan(["mop"], d, t)
            }
            var f = 0, v = 0;
            return ((i instanceof ew || "\\oiint" === n.name || "\\oiiint" === n.name) && !n.suppressBaseShift && (f = (i.height - i.depth) / 2 - t.fontMetrics().axisHeight, v = i.italic), s) ? at(i, r, a, t, o, v, f) : (f && (i.style.position = "relative", i.style.top = ep(f)), i)
        }, an = (e, t) => {
            var r;
            if (e.symbol) r = new tD("mo", [tG(e.name, e.mode)]), H.contains(ar, e.name) && r.setAttribute("largeop", "false"); else if (e.body) r = new tD("mo", tX(e.body, t)); else {
        ...
        ty({
            ...
            type: "op", names: ["\\mathop"], props: {numArgs: 1, primitive: !0}, handler: (e, t) => {
                ...
                return {type: "op", mode: r.mode, limits: !1, parentIsSupSub: !1, symbol: !1, body: tk(a)}
            }, htmlBuilder: aa, mathmlBuilder: an
        });
        var as = {"∫": "\\int", "∬": "\\iint", "∭": "\\iiint", "∮": "\\oint", "∯": "\\oiint", "∰": "\\oiiint"};
        ty({
            type: "op",
        ...
        var ao = (e, t) => {
            var r, a, n, i, s = !1;
            if ("supsub" === e.type ? (r = e.sup, a = e.sub, n = t4(e.base, "operatorname"), s = !0) : n = t4(e, "operatorname"), n.body.length > 0) {
                for (var o = tB(n.body.map(e => {
                    var t = e.text;
                    return "string" == typeof t ? {type: "textord", mode: e.mode, text: t} : e
                }), t.withFont("mathrm"), !0), l = 0; l < o.length; l++) {
                    var h = o[l];
                    h instanceof ew && (h.text = h.text.replace(/\u2212/, "-").replace(/\u2217/, "*"))
                }
        ...
        function al(e, t, r) {
            for (var a = tB(e, t, !1), n = t.sizeMultiplier / r.sizeMultiplier, i = 0; i < a.length; i++) {
        ...
        ty({
            ...
            htmlBuilder: ao,
            mathmlBuilder: (e, t) => {
                for (var r = tX(e.body, t.withFont("mathrm")), a = !0, n = 0; n < r.length; n++) {
                    var i = r[n];
                    if (i instanceof tF.SpaceNode) ; else if (i instanceof tF.MathNode) switch (i.type) {
                        case"mi":
                        case"mn":
                        case"ms":
                        case"mspace":
        ...
        }), rY["\\operatorname"] = "\\@ifstar\\operatornamewithlimits\\operatorname@", tx({
            type: "ordgroup",
            htmlBuilder: (e, t) => e.semisimple ? tm.makeFragment(tB(e.body, t, !1)) : tm.makeSpan(["mord"], tB(e.body, t, !0), t),
            ...
            type: "overline", names: ["\\overline"], props: {numArgs: 1}, handler(e, t) {
                ...
                var r = tR(e.body, t.havingCrampedStyle()), a = tm.makeLineSpan("overline-line", t),
                    n = t.fontMetrics().defaultRuleThickness, i = tm.makeVList({
                        positionType: "firstBaseline",
            ...
            type: "hphantom", names: ["\\hphantom"], props: {numArgs: 1, allowedInText: !0}, handler: (e, t) => {
                ...
                return r = tm.makeVList({
                    positionType: "firstBaseline",
                    children: [{type: "elem", elem: r}]
                }, t), tm.makeSpan(["mord"], [r], t)
            }, mathmlBuilder: (e, t) => {
                var r = tX(tk(e.body), t), a = new tF.MathNode("mphantom", r), n = new tF.MathNode("mpadded", [a]);
            ...
            type: "vphantom", names: ["\\vphantom"], props: {numArgs: 1, allowedInText: !0}, handler: (e, t) => {
                ...
                var r = tm.makeSpan(["inner"], [tR(e.body, t.withPhantom())]), a = tm.makeSpan(["fix"], []);
            ...
            handler(e, t) {
                var {parser: r} = e, a = t4(t[0], "size").value, n = t[1];
                return {type: "raisebox", mode: r.mode, dy: a, body: n}
            },
            htmlBuilder(e, t) {
                var r = tR(e.body, t), a = ec(e.dy, t);
                return tm.makeVList({positionType: "shift", positionData: -a, children: [{type: "elem", elem: r}]}, t)
            },
            mathmlBuilder(e, t) {
                var r = new tF.MathNode("mpadded", [t_(e.body, t)]), a = e.dy.number + e.dy.unit;
            ...
            handler(e, t, r) {
                var {parser: a} = e, n = r[0], i = t4(t[0], "size"), s = t4(t[1], "size");
                return {type: "rule", mode: a.mode, shift: n && t4(n, "size").value, width: i.value, height: s.value}
            },
            htmlBuilder(e, t) {
                var r = tm.makeSpan(["mord", "rule"], [], t), a = ec(e.width, t), n = ec(e.height, t),
            ...
            mathmlBuilder(e, t) {
                var r = ec(e.width, t), a = ec(e.height, t), n = e.shift ? ec(e.shift, t) : 0,
                    i = t.color && t.getColor() || "black", s = new tF.MathNode("mspace");
        ...
        var ah = ["\\tiny", "\\sixptsize", "\\scriptsize", "\\footnotesize", "\\small", "\\normalsize", "\\large", "\\Large", "\\LARGE", "\\huge", "\\Huge"];
        ty({
            type: "sizing", names: ah, props: {numArgs: 0, allowedInText: !0}, handler: (e, t) => {
                var {breakOnTokenText: r, funcName: a, parser: n} = e, i = n.parseExpression(!1, r);
                return {type: "sizing", mode: n.mode, size: ah.indexOf(a) + 1, body: i}
            }, htmlBuilder: (e, t) => {
                var r = t.havingSize(e.size);
                return al(e.body, r, t)
            }, mathmlBuilder: (e, t) => {
                var r = t.havingSize(e.size), a = tX(e.body, r), n = new tF.MathNode("mstyle", a);
            ...
            handler: (e, t, r) => {
                var {parser: a} = e, n = !1, i = !1, s = r[0] && t4(r[0], "ordgroup");
            ...
            htmlBuilder: (e, t) => {
                ...
                var i = tm.makeVList({positionType: "firstBaseline", children: [{type: "elem", elem: r}]}, t);
            ...
            type: "sqrt", names: ["\\sqrt"], props: {numArgs: 1, numOptionalArgs: 1}, handler(e, t, r) {
                ...
                0 === r.height && (r.height = t.fontMetrics().xHeight), r = tm.wrapFragment(r, t);
                ...
                var u = t.havingStyle(Y.SCRIPTSCRIPT), d = tR(e.index, u, t), g = .6 * (p.height - p.depth),
                    f = tm.makeVList({positionType: "shift", positionData: -g, children: [{type: "elem", elem: d}]}, t),
                    v = tm.makeSpan(["root"], [f]);
                return tm.makeSpan(["mord", "sqrt"], [v, p], t)
            }, mathmlBuilder(e, t) {
                var {body: r, index: a} = e;
                return a ? new tF.MathNode("mroot", [t_(r, t), t_(a, t)]) : new tF.MathNode("msqrt", [t_(r, t)])
            }
        });
        var am = {display: Y.DISPLAY, text: Y.TEXT, script: Y.SCRIPT, scriptscript: Y.SCRIPTSCRIPT};
        ty({
            type: "styling",
            ...
            htmlBuilder(e, t) {
                var r = am[e.style], a = t.havingStyle(r).withFont("");
                return al(e.body, a, t)
            },
            mathmlBuilder(e, t) {
                var r = am[e.style], a = t.havingStyle(r), n = tX(e.body, a), i = new tF.MathNode("mstyle", n), s = {
                    display: ["0", "true"],
                    text: ["0", "false"],
                    script: ["1", "false"],
        ...
        var ac = function (e, t) {
            var r = e.base;
            return r ? "op" === r.type ? r.limits && (t.style.size === Y.DISPLAY.size || r.alwaysHandleSupSub) ? aa : null : "operatorname" === r.type ? r.alwaysHandleSupSub && (t.style.size === Y.DISPLAY.size || r.limits) ? ao : null : "accent" === r.type ? H.isCharacterBox(r.base) ? t7 : null : "horizBrace" === r.type ? !e.sub === r.isOver ? r2 : null : null : null
        };
        tx({
            type: "supsub", htmlBuilder(e, t) {
                var r, a, n, i, s = ac(e, t);
                if (s) return s(e, t);
                var {base: o, sup: l, sub: h} = e, m = tR(o, t), c = t.fontMetrics(), p = 0, u = 0,
                    d = o && H.isCharacterBox(o);
                if (l) {
                    var g = t.havingStyle(t.style.sup());
                    r = tR(l, g, t), d || (p = m.height - g.fontMetrics().supDrop * g.sizeMultiplier / t.sizeMultiplier)
                }
                if (h) {
                    var f = t.havingStyle(t.style.sub());
                    a = tR(h, f, t), d || (u = m.depth + f.fontMetrics().subDrop * f.sizeMultiplier / t.sizeMultiplier)
                }
                n = t.style === Y.DISPLAY ? c.sup1 : t.style.cramped ? c.sup3 : c.sup2;
                var v = t.sizeMultiplier, b = ep(.5 / c.ptPerEm / v), y = null;
                if (a) {
                ...
                if (r && a) {
                    ...
                    var S = [{type: "elem", elem: a, shift: u, marginRight: b, marginLeft: y}, {
                        type: "elem",
                        elem: r,
                        shift: -p,
                        marginRight: b
                    }];
                    i = tm.makeVList({positionType: "individualShift", children: S}, t)
                } else if (a) {
                    u = Math.max(u, c.sub1, a.height - .8 * c.xHeight);
                    var M = [{type: "elem", elem: a, marginLeft: y, marginRight: b}];
                    i = tm.makeVList({positionType: "shift", positionData: u, children: M}, t)
                } else if (r) p = Math.max(p, n, r.depth + .25 * c.xHeight), i = tm.makeVList({
                    positionType: "shift",
                    positionData: -p,
                ...
                var i = [t_(e.base, t)];
                if (e.sub && i.push(t_(e.sub, t)), e.sup && i.push(t_(e.sup, t)), n) a = r ? "mover" : "munder"; else if (e.sub) {
                    if (e.sup) {
                        var s = e.base;
            ...
            type: "atom",
            htmlBuilder: (e, t) => tm.mathsym(e.text, e.mode, t, ["m" + e.family]),
            mathmlBuilder(e, t) {
        ...
        tx({
            type: "mathord", htmlBuilder: (e, t) => tm.makeOrd(e, t, "mathord"), mathmlBuilder(e, t) {
                var r = new tF.MathNode("mi", [tG(e.text, e.mode, t)]), a = tY(e, t) || "italic";
                return a !== ap[r.type] && r.setAttribute("mathvariant", a), r
            }
        }), tx({
            type: "textord", htmlBuilder: (e, t) => tm.makeOrd(e, t, "textord"), mathmlBuilder(e, t) {
                var r, a = tG(e.text, e.mode, t), n = tY(e, t) || "normal";
                return n !== ap[(r = "text" === e.mode ? new tF.MathNode("mtext", [a]) : /[0-9]/.test(e.text) ? new tF.MathNode("mn", [a]) : "\\prime" === e.text ? new tF.MathNode("mo", [a]) : new tF.MathNode("mi", [a])).type] && r.setAttribute("mathvariant", n), r
            }
        });
        var au = {"\\nobreak": "nobreak", "\\allowbreak": "allowbreak"}, ad = {
            " ": {},
            "\\ ": {},
            "~": {className: "nobreak"},
            "\\space": {},
        ...
        tx({
            type: "spacing", htmlBuilder(e, t) {
                if (ad.hasOwnProperty(e.text)) {
                    ...
                    if ("text" !== e.mode) return tm.makeSpan(["mspace", r], [tm.mathsym(e.text, e.mode, t)], t);
                    var a = tm.makeOrd(e, t, "textord");
                    return a.classes.push(r), a
                }
                if (au.hasOwnProperty(e.text)) return tm.makeSpan(["mspace", au[e.text]], [], t);
                throw new i('Unknown type of space "' + e.text + '"')
            }, mathmlBuilder(e, t) {
                var r;
                if (ad.hasOwnProperty(e.text)) r = new tF.MathNode("mtext", [new tF.TextNode("\xa0")]); else if (au.hasOwnProperty(e.text)) return new tF.MathNode("mspace"); else throw new i('Unknown type of space "' + e.text + '"');
                return r
            }
        });
        var ag = () => {
        ...
        tx({
            type: "tag", mathmlBuilder(e, t) {
                var r = new tF.MathNode("mtable", [new tF.MathNode("mtr", [ag(), new tF.MathNode("mtd", [tW(e.body, t)]), ag(), new tF.MathNode("mtd", [tW(e.tag, t)])])]);
        ...
        var af = {
                ...
                "\\texttt": "texttt",
                "\\textnormal": "textrm"
            }, av = {"\\textbf": "textbf", "\\textmd": "textmd"}, ab = {"\\textit": "textit", "\\textup": "textup"},
            ay = (e, t) => {
                var r = e.font;
                return r ? af[r] ? t.withTextFontFamily(af[r]) : av[r] ? t.withTextFontWeight(av[r]) : t.withTextFontShape(ab[r]) : t
            };
        ty({
            type: "text",
            ...
            type: "underline", names: ["\\underline"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                ...
                var r = tR(e.body, t), a = tm.makeLineSpan("underline-line", t),
                    n = t.fontMetrics().defaultRuleThickness, i = tm.makeVList({
                        positionType: "top",
                        positionData: r.height,
            ...
            htmlBuilder(e, t) {
                var r = tR(e.body, t), a = t.fontMetrics().axisHeight, n = .5 * (r.height - a - (r.depth + a));
                return tm.makeVList({positionType: "shift", positionData: n, children: [{type: "elem", elem: r}]}, t)
            },
            mathmlBuilder: (e, t) => new tF.MathNode("mpadded", [t_(e.body, t)], ["vcenter"])
        }), ty({
            type: "verb", names: ["\\verb"], props: {numArgs: 0, allowedInText: !0}, handler(e, t, r) {
                ...
                for (var r = ax(e), a = [], n = t.havingStyle(t.style.text()), i = 0; i < r.length; i++) {
                    var s = r[i];
                    "~" === s && (s = "\\textasciitilde"), a.push(tm.makeSymbol(s, "Typewriter-Regular", e.mode, n, ["mord", "texttt"]))
                }
                return tm.makeSpan(["mord", "text"].concat(n.sizingClasses(t)), tm.tryCombineChars(a), n)
            }, mathmlBuilder(e, t) {
                var r = new tF.TextNode(ax(e)), a = new tF.MathNode("mtext", [r]);
                return a.setAttribute("mathvariant", "monospace"), a
            }
        });
        var ax = e => e.body.replace(/ /g, e.star ? "␣" : "\xa0"), aw = "[ \r\n	]", ak = "[̀-ͯ]",
            aS = RegExp(ak + "+$"),
            aM = "(" + aw + "+)|\\\\(\n|[ \r	]+\n?)[ \r	]*|([!-\\[\\]-‧‪-퟿豈-￿]" + ak + "*|[\uD800-\uDBFF][\uDC00-\uDFFF]" + ak + "*|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5|(\\\\[a-zA-Z@]+)" + aw + "*|\\\\[^\uD800-\uDFFF])";
        ...
        }, rY["\\expandafter"] = o, l = function (e) {
            return {tokens: e.consumeArgs(2)[0], numArgs: 0}
        }, rY["\\@firstoftwo"] = l, h = function (e) {
            return {tokens: e.consumeArgs(2)[1], numArgs: 0}
        }, rY["\\@secondoftwo"] = h, m = function (e) {
        ...
        }, rY["\\@ifnextchar"] = m, rY["\\@ifstar"] = "\\@ifnextchar *{\\@firstoftwo{#1}}", c = function (e) {
        ...
        p = function (e) {
            ...
            if (t) {
                if (null == (n = aT[a.text]) || n >= t) throw new i("Invalid base-" + t + " digit " + a.text);
                for (; null != (r = aT[e.future().text]) && r < t;) n *= t, n += r, e.popToken()
            }
            return "\\@char{" + n + "}"
        }, rY["\\char"] = p;
        var aB = (e, t, r) => {
        ...
        y = function (e) {
            ...
            return r in aC ? t = aC[r] : "\\not" === r.slice(0, 4) ? t = "\\dotsb" : r in eB.math && H.contains(["bin", "rel"], eB.math[r].group) && (t = "\\dotsb"), t
        }, rY["\\dots"] = y;
        var aq = {
            ")": !0,
            "]": !0,
        ...
        class aR {
            constructor(e, t, r) {
                this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new aA(rY, t.macros), this.mode = r, this.stack = []
            }
            ...
            _getExpansion(e) {
                ...
                if ("string" == typeof a) {
                    ...
                    for (var s = new az(a, this.settings), o = [], l = s.lex(); "EOF" !== l.text;) o.push(l), l = s.lex();
            ...
            isDefined(e) {
                return this.macros.has(e) || tf.hasOwnProperty(e) || eB.math.hasOwnProperty(e) || eB.text.hasOwnProperty(e) || aH.hasOwnProperty(e)
            }

            isExpandable(e) {
                var t = this.macros.get(e);
                return null != t ? "string" == typeof t || "function" == typeof t || !t.unexpandable : tf.hasOwnProperty(e) && !tf[e].primitive
            }
        }

        var aO = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, aE = Object.freeze({
            "₊": "+",
            "₋": "-",
            "₌": "=",
            "₍": "(",
        ...
        class aV {
            constructor(e, t) {
                this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new aR(e, t, this.mode), this.settings = t, this.leftrightDepth = 0
            }
            ...
            parseExpression(e, t) {
                for (var r = []; ;) {
                    ...
                    var a = this.fetch();
                    if (-1 !== aV.endOfExpression.indexOf(a.text) || t && a.text === t || e && tf[a.text] && tf[a.text].infix) break;
            ...
            parseAtom(e) {
                ...
                for (; ;) {
                    ...
                    if ("\\limits" === s.text || "\\nolimits" === s.text) {
                        ...
                        } else if (a && "operatorname" === a.type) a.alwaysHandleSupSub && (a.limits = "\\limits" === s.text); else throw new i("Limit controls must follow a math operator", s);
                        this.consume()
                    } else if ("^" === s.text) {
                        ...
                        m ? r = {type: "ordgroup", mode: "math", body: u} : t = {
                            type: "ordgroup",
                            mode: "math",
                            body: u
                        }
            ...
            parseFunction(e, t) {
                var r = this.fetch(), a = r.text, n = tf[a];
                if (!n) return null;
            ...
            parseGroup(e, t) {
                ...
                } else if (null == (r = this.parseFunction(t, e) || this.parseSymbol()) && "\\" === s[0] && !aH.hasOwnProperty(s)) {
            ...
            parseSymbol() {
                ...
                aD.hasOwnProperty(t[0]) && !eB[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = aD[t[0]] + t.slice(1));
                var s = aS.exec(t);
                if (s && ("i" === (t = t.substring(0, s.index)) ? t = "ı" : "j" === t && (t = "ȷ")), eB[this.mode][t]) {
                    this.settings.strict && "math" === this.mode && e5.indexOf(t) >= 0 && this.settings.reportNonstrict("unicodeTextInMathMode", 'Latin-1/Unicode text character "' + t[0] + '" used in math mode', e);
                    var o, l = eB[this.mode][t].group, h = a.range(e);
                    o = eA.hasOwnProperty(l) ? {type: "atom", mode: this.mode, family: l, loc: h, text: t} : {
                        type: l,
                        mode: this.mode,
                        loc: h,
                        text: t
                    ...
                    this.settings.strict && (_(t.charCodeAt(0)) ? "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '" (' + t.charCodeAt(0) + ")", e)), o = {
                        type: "textord",
                        mode: "text",
                        loc: a.range(e),
                        text: t
        ...
        "undefined" != typeof document && "CSS1Compat" !== document.compatMode && ("undefined" != typeof console && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), aF = function () {
        ...
        var aG = function (e, t, r) {
            ...
            version: "0.16.10", render: aF, renderToString: function (e, t) {
                return aU(e, t).toMarkup()
            }, ParseError: i, SETTINGS_SCHEMA: R, __parse: function (e, t) {
                return aP(e, new O(t))
            }, __renderToDomTree: aU, __renderToHTMLTree: function (e, t) {
                var r = new O(t);
                try {
                    var a = aP(e, r);
                    return tJ(a, e, r)
                ...
                Q[e] = t
            }, __defineSymbol: eC, __defineFunction: ty, __defineMacro: function (e, t) {
                rY[e] = t
            }, __domTree: {Span: ev, Anchor: eb, SymbolNode: ew, SvgNode: ek, PathNode: eS, LineNode: eM}
        }
    }
}]);