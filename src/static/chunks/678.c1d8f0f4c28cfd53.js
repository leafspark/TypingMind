...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[678], {
    24678: function (e, t, n) {
        ...
        function l(e, t = i()) {
            return t("readwrite", t => (e.forEach(e => t.put(e[1], e[0])), u(t.transaction)))
        }
        ...
        function f(e, t, n = i()) {
            return n("readwrite", n => new Promise((r, o) => {
        ...
        function y(e, t = i()) {
            return t("readwrite", t => (e.forEach(e => t.delete(e)), u(t.transaction)))
        }
        ...
        function k(e = i()) {
            return e("readonly", t => {
                if (t.getAll && t.getAllKeys) return Promise.all([u(t.getAllKeys()), u(t.getAll())]).then(([e, t]) => e.map((e, n) => [e, t[n]]));
                let n = [];
                return e("readonly", e => p(e, e => n.push([e.key, e.value])).then(() => n))
            })
        }
