...
const e = !("object" != typeof process || process + "" != "[object process]" || process.versions.nw || process.versions.electron && process.type && "browser" !== process.type),
    i = [1, 0, 0, 1, 0, 0], s = [.001, 0, 0, .001, 0, 0], n = 1.35, a = 1, r = 2, o = 4, h = 16, l = 32, d = 64,
    c = 256, u = {DISABLE: 0, ENABLE: 1, ENABLE_FORMS: 2, ENABLE_STORAGE: 3},
    p = {DISABLE: -1, NONE: 0, FREETEXT: 3, HIGHLIGHT: 9, STAMP: 13, INK: 15}, g = {
        RESIZE: 1,
        CREATE: 2,
        FREETEXT_SIZE: 11,
        FREETEXT_COLOR: 12,
    ...
    }, f = 0, b = 1, v = 2, A = 3, y = 3, w = 4, x = {GRAYSCALE_1BPP: 1, RGB_24BPP: 2, RGBA_32BPP: 3}, E = 1, _ = 2, C = 3,
    S = 4, T = 5, M = 6, k = 7, P = 8, D = 9, R = 10, F = 11, I = 12, L = 13, O = 14, N = 15, B = 16, H = 17, z = 20,
    U = 1, j = 2, $ = 3, V = 4, G = 5, W = {ERRORS: 0, WARNINGS: 1, INFOS: 5}, q = {NONE: 0, BINARY: 1}, X = {
        dependency: 1,
        setLineWidth: 2,
        setLineCap: 3,
        setLineJoin: 4,
...
function info(t) {
    Y >= W.INFOS && console.log(`Info: ${t}`)
}

function warn(t) {
    Y >= W.WARNINGS && console.log(`Warning: ${t}`)
}
...
class Util {
    ...
    static getAxialAlignedBoundingBox(t, e) {
        const i = this.applyTransform(t, e), s = this.applyTransform(t.slice(2, 4), e),
            n = this.applyTransform([t[0], t[3]], e), a = this.applyTransform([t[2], t[1]], e);
    ...
    static singularValueDecompose2dScale(t) {
        const e = [t[0], t[2], t[1], t[3]], i = t[0] * e[0] + t[1] * e[2], s = t[0] * e[1] + t[1] * e[3],
            n = t[2] * e[0] + t[3] * e[2], a = t[2] * e[1] + t[3] * e[3], r = (i + a) / 2,
            o = Math.sqrt((i + a) ** 2 - 4 * (i * a - n * s)) / 2, h = r + o || 1, l = r - o || 1;
    ...
    static #t(t, e, i, s, n, a, r, o, h, l) {
        if (h <= 0 || h >= 1) return;
        const d = 1 - h, c = h * h, u = c * h, p = d * (d * (d * t + 3 * h * e) + 3 * c * i) + u * s,
            g = d * (d * (d * n + 3 * h * a) + 3 * c * r) + u * o;
        l[0] = Math.min(l[0], p);
        l[1] = Math.min(l[1], g);
        l[2] = Math.max(l[2], p);
        l[3] = Math.max(l[3], g)
    ...
    static #e(t, e, i, s, n, a, r, o, h, l, d, c) {
        if (Math.abs(h) < 1e-12) {
            Math.abs(l) >= 1e-12 && this.#t(t, e, i, s, n, a, r, o, -d / l, c);
            return
        }
        const u = l ** 2 - 4 * d * h;
        if (u < 0) return;
        const p = Math.sqrt(u), g = 2 * h;
        this.#t(t, e, i, s, n, a, r, o, (-l + p) / g, c);
        this.#t(t, e, i, s, n, a, r, o, (-l - p) / g, c)
    }
    ...
    static bezierBoundingBox(t, e, i, s, n, a, r, o, h) {
        ...
        } else h = [Math.min(t, r), Math.min(e, o), Math.max(t, r), Math.max(e, o)];
        this.#e(t, i, n, r, e, s, a, o, 3 * (3 * (i - n) - t + r), 6 * (t - 2 * i + n), 3 * (i - t), h);
        this.#e(t, i, n, r, e, s, a, o, 3 * (3 * (s - a) - e + o), 6 * (e - 2 * s + a), 3 * (s - e), h);
        return h
    }
}
...
const et = "pdfjs_internal_id_", it = 0, st = 1, nt = 2, at = 3, rt = 4, ot = 5, ht = 6, lt = 7, dt = 8;
...
class PageViewport {
    constructor({viewBox: t, scale: e, rotation: i, offsetX: s = 0, offsetY: n = 0, dontFlip: a = !1}) {
        ...
        this.transform = [h * e, l * e, d * e, c * e, u - h * e * r - d * e * o, p - l * e * r - c * e * o];
        this.width = g;
        this.height = m
    }
...
function getXfaPageViewport(t, {scale: e = 1, rotation: i = 0}) {
    const {width: s, height: n} = t.attributes.style, a = [0, 0, parseInt(s), parseInt(n)];
...
function setLayerDimensions(t, e, i = !1, s = !0) {
    if (e instanceof PageViewport) {
        const {pageWidth: s, pageHeight: n} = e.rawDims, {style: a} = t, r = util_FeatureTest.isCSSRoundSupported,
            o = `var(--scale-factor) * ${s}px`, h = `var(--scale-factor) * ${n}px`,
            l = r ? `round(${o}, 1px)` : `calc(${o})`, d = r ? `round(${h}, 1px)` : `calc(${h})`;
...
class EditorToolbar {
    ...
    render() {
        ...
        if (i) {
            const {style: e} = t, s = "ltr" === this.#n._uiManager.direction ? 1 - i[0] : i[0];
    ...
    #d(t) {
        t.addEventListener("focusin", this.#h.bind(this), {capture: !0});
        t.addEventListener("focusout", this.#l.bind(this), {capture: !0});
        t.addEventListener("contextmenu", noContextMenu)
    }
    ...
    #o() {
        ...
        t.className = "delete";
        t.tabIndex = 0;
        t.setAttribute("data-l10n-id", `pdfjs-editor-remove-${this.#n.editorType}-button`);
        this.#d(t);
...
class HighlightToolbar {
    ...
    show(t, e, i) {
        const [s, n] = this.#m(e, i), {style: a} = this.#i ||= this.#p();
        t.append(this.#i);
...
class ImageManager {
    ...
    async #A(t, e) {
        ...
        try {
            i ||= {bitmap: null, id: `image_${this.#b}_${this.#f++}`, refCounter: 0, isSvg: !1};
            let t;
            if ("string" == typeof e) {
                i.url = e;
            ...
            if ("image/svg+xml" === t.type) {
                const e = ImageManager._isSVGFittingCanvas, s = new FileReader, n = new Image,
                    a = new Promise(((t, a) => {
                        n.onload = () => {
                            i.bitmap = n;
                            i.isSvg = !0;
...
class CommandManager {
    ...
    add({cmd: t, undo: e, post: i, mustExec: s, type: n = NaN, overwriteIfSameType: a = !1, keepUndo: r = !1}) {
        ...
        const h = this.#E + 1;
        if (h === this.#x) this.#y.splice(0, 1); else {
            this.#E = h;
            h < this.#y.length && this.#y.splice(h)
        }
        this.#y.push(o)
    }
...
class AnnotationEditorUIManager {
    ...
    #ht = this.onPageChanging.bind(this);
    #lt = this.onScaleChanging.bind(this);
    ...
    static get _keyboardManager() {
        const t = AnnotationEditorUIManager.prototype,
            arrowChecker = t => t.#ft.contains(document.activeElement) && "BUTTON" !== document.activeElement.tagName && t.hasSomethingToControl(),
    ...
    constructor(t, e, i, s, n, a, r, o, h) {
        this.#ft = t;
        this.#bt = e;
        this.#M = i;
        this._eventBus = s;
        this._eventBus._on("editingaction", this.#ot);
        this._eventBus._on("pagechanging", this.#ht);
        this._eventBus._on("scalechanging", this.#lt);
    ...
    destroy() {
        ...
        this._eventBus._off("pagechanging", this.#ht);
        this._eventBus._off("scalechanging", this.#lt);
    ...
    get hcmFilter() {
        return shadow(this, "hcmFilter", this.#J ? this.#B.addHCMFilter(this.#J.foreground, this.#J.background) : "none")
    }
    ...
    get highlightColors() {
        return shadow(this, "highlightColors", this.#z ? new Map(this.#z.split(",").map((t => t.split("=").map((t => t.trim()))))) : null)
    }
    ...
    highlightSelection(t = "") {
        ...
        const {anchorNode: i, anchorOffset: s, focusNode: n, focusOffset: a} = e, r = e.toString(),
            o = this.#Et(e).closest(".textLayer"), h = this.getSelectionBoxes(o);
        if (h) {
            e.empty();
            if (this.#K === p.NONE) {
                this._eventBus.dispatch("showannotationeditorui", {source: this, mode: p.HIGHLIGHT});
                this.showAllEditors("highlight", !0, !0)
            }
            for (const e of this.#T.values()) if (e.hasTextLayer(o)) {
    ...
    #_t() {
        ...
        const e = this.#Et(t).closest(".textLayer"), i = this.getSelectionBoxes(e);
        if (i) {
    ...
    #St(t = "") {
        this.#K === p.HIGHLIGHT ? this.highlightSelection(t) : this.#N && this.#_t()
    }
    ...
    paste(t) {
        ...
        for (const t of e.items) for (const e of this.#L) if (e.isHandlingMimeForPasting(t.type)) {
    ...
    keydown(t) {
        ...
        this.#K === p.NONE || this.isEditorHandlingKeyboard || AnnotationEditorUIManager._keyboardManager.exec(this, t)
    }
    ...
    #Ct(t) {
        if (Object.entries(t).some((([t, e]) => this.#pt[t] !== e))) {
            ...
            this.#K === p.HIGHLIGHT && !1 === t.hasSelectedEditor && this.#Rt([[g.HIGHLIGHT_FREE, !0]])
        }
    }
    ...
    registerEditorTypes(t) {
        if (!this.#L) {
            this.#L = t;
            for (const t of this.#L) this.#Rt(t.defaultPropertiesToUpdate)
        }
    }
    ...
    updateMode(t, e = null, i = !1) {
        if (this.#K !== t) {
            ...
            if (t !== p.NONE) {
                ...
                if (e || !i) {
                    if (e) for (const t of this.#S.values()) if (t.annotationElementId === e) {
                        this.setSelected(t);
                        t.enterInEditMode();
                        break
                    }
    ...
    updateToolbar(t) {
        t !== this.#K && this._eventBus.dispatch("switchannotationeditormode", {source: this, mode: t})
    }
    ...
    showAllEditors(t, e, i = !1) {
        ...
        (this.#Z?.get(g.HIGHLIGHT_SHOW_ALL) ?? !0) !== e && this.#Rt([[g.HIGHLIGHT_SHOW_ALL, e]])
    }
    ...
    removeEditor(t) {
        ...
        this.#S.delete(t.id);
        this.unselect(t);
        t.annotationElementId && this.#F.has(t.annotationElementId) || this.#k?.remove(t.id)
    }

    addDeletedAnnotationElement(t) {
        this.#F.add(t.annotationElementId);
    ...
    removeDeletedAnnotationElement(t) {
        this.#F.delete(t.annotationElementId);
    ...
    undo() {
        this.#D.undo();
        this.#Ct({hasSomethingToUndo: this.#D.hasSomethingToUndo(), hasSomethingToRedo: !0, isEmpty: this.#Ft()})
    }

    redo() {
        this.#D.redo();
        this.#Ct({hasSomethingToUndo: !0, hasSomethingToRedo: this.#D.hasSomethingToRedo(), isEmpty: this.#Ft()})
    }

    addCommands(t) {
        this.#D.add(t);
        this.#Ct({hasSomethingToUndo: !0, hasSomethingToRedo: !1, isEmpty: this.#Ft()})
    }

    #Ft() {
        if (0 === this.#S.size) return !0;
        if (1 === this.#S.size) for (const t of this.#S.values()) return t.isEmpty();
        return !1
    }
    ...
    setUpDragSession() {
        if (this.hasSelection) {
            ...
            this.#I = new Map;
            for (const t of this.#Y) this.#I.set(t, {
                savedX: t.x,
                savedY: t.y,
    ...
    get isEditorHandlingKeyboard() {
        return this.getActive()?.shouldGetKeyboardEvents() || 1 === this.#Y.size && this.firstSelectedEditor.shouldGetKeyboardEvents()
    }
    ...
    getSelectionBoxes(t) {
        ...
        for (let t = 0, i = e.rangeCount; t < i; t++) {
            ...
            if (!i.collapsed) for (const {
                x: t,
                y: e,
                width: s,
                height: n
            } of i.getClientRects()) 0 !== s && 0 !== n && o.push(r(t, e, s, n))
        }
    ...
    renderAnnotationElement(t) {
        ...
        i && (this.#K !== p.NONE || i.hasBeenModified) && i.renderAnnotationElement(t)
    }
}
...
class AltText {
    ...
    finish() {
        if (this.#Ht) {
            this.#Ht.focus({focusVisible: this.#jt});
            this.#jt = !1
        }
    }
    ...
    async #$t() {
        ...
        e.innerText = this.#Bt ? await AltText._l10nPromise.get("pdfjs-editor-alt-text-decorative-tooltip") : this.#Nt;
...
class AnnotationEditor {
    ...
    static get _resizerKeyboardManager() {
        const t = AnnotationEditor.prototype._resizeWithKeyboard, e = AnnotationEditorUIManager.TRANSLATE_SMALL,
            i = AnnotationEditorUIManager.TRANSLATE_BIG;
        return shadow(this, "_resizerKeyboardManager", new KeyboardManager([[["ArrowLeft", "mac+ArrowLeft"], t, {args: [-e, 0]}], [["ctrl+ArrowLeft", "mac+shift+ArrowLeft"], t, {args: [-i, 0]}], [["ArrowRight", "mac+ArrowRight"], t, {args: [e, 0]}], [["ctrl+ArrowRight", "mac+shift+ArrowRight"], t, {args: [i, 0]}], [["ArrowUp", "mac+ArrowUp"], t, {args: [0, -e]}], [["ctrl+ArrowUp", "mac+shift+ArrowUp"], t, {args: [0, -i]}], [["ArrowDown", "mac+ArrowDown"], t, {args: [0, e]}], [["ctrl+ArrowDown", "mac+shift+ArrowDown"], t, {args: [0, i]}], [["Escape", "mac+Escape"], AnnotationEditor.prototype._stopResizingWithKeyboard]]))
    }
    ...
    focusin(t) {
        this._focusEventsAllowed && (this.#Zt ? this.#Zt = !1 : this.parent.setSelected(this))
    }
    ...
    get parentDimensions() {
        ...
        return util_FeatureTest.isCSSRoundSupported ? [Math.round(s), Math.round(n)] : [s, n]
    }

    setDims(t, e) {
        const [i, s] = this.parentDimensions;
        this.div.style.width = `${(100 * t / i).toFixed(2)}%`;
        this.#Wt || (this.div.style.height = `${(100 * e / s).toFixed(2)}%`)
    }

    fixDims() {
        const {style: t} = this.div, {height: e, width: i} = t, s = i.endsWith("%"), n = !this.#Wt && e.endsWith("%");
        if (s && n) return;
        const [a, r] = this.parentDimensions;
        s || (t.width = `${(100 * parseFloat(i) / a).toFixed(2)}%`);
        this.#Wt || n || (t.height = `${(100 * parseFloat(e) / r).toFixed(2)}%`)
    }
    ...
    #me(t, e) {
        ...
        this.#Nt?.toggle(!1);
        const s = this.#fe.bind(this, t), n = this._isDraggable;
        this._isDraggable = !1;
        const a = {passive: !0, capture: !0};
        this.parent.togglePointerEvents(!1);
        window.addEventListener("pointermove", s, a);
        window.addEventListener("contextmenu", noContextMenu);
        const r = this.x, o = this.y, h = this.width, l = this.height, d = this.parent.div.style.cursor,
    ...
    #fe(t, e) {
        const [i, s] = this.parentDimensions, n = this.x, a = this.y, r = this.width, o = this.height,
            h = AnnotationEditor.MIN_SIZE / i, l = AnnotationEditor.MIN_SIZE / s,
            round = t => Math.round(1e4 * t) / 1e4, d = this.#pe(this.rotation),
            transf = (t, e) => [d[0] * t + d[2] * e, d[1] * t + d[3] * e], c = this.#pe(360 - this.rotation);
        let u, p, g = !1, m = !1;
        switch (t) {
            case"topLeft":
                g = !0;
        ...
        let w = 1, x = 1, [E, _] = this.screenToPageTranslation(e.movementX, e.movementY);
        [E, _] = (C = E / i, S = _ / s, [c[0] * C + c[2] * S, c[1] * C + c[3] * S]);
        var C, S;
        if (g) {
            const t = Math.hypot(r, o);
            w = x = Math.max(Math.min(Math.hypot(b[0] - f[0] - E, b[1] - f[1] - _) / t, 1 / r, 1 / o), h / r, l / o)
        } else m ? w = Math.max(h, Math.min(1, Math.abs(b[0] - f[0] - E))) / r : x = Math.max(l, Math.min(1, Math.abs(b[1] - f[1] - _))) / o;
    ...
    #ve(t) {
        ...
        if (e) {
            ...
            this.#re = t.clientY;
            s = t => {
                const {clientX: e, clientY: i} = t, [s, n] = this.screenToPageTranslation(e - this.#ae, i - this.#re);
                this.#ae = e;
                this.#re = i;
    ...
    getRect(t, e, i = this.rotation) {
        const s = this.parentScale, [n, a] = this.pageDimensions, [r, o] = this.pageTranslation, h = t / s, l = e / s,
            d = this.x * n, c = this.y * a, u = this.width * n, p = this.height * a;
        switch (i) {
            case 0:
                return [d + h + r, a - c - l - p + o, d + h + u + r, a - c - l + o];
            case 90:
                return [d + l + r, a - c + h + o, d + l + p + r, a - c + h + u + o];
            case 180:
                return [d - h - u + r, a - c + l + o, d - h + r, a - c + l + p + o];
            case 270:
                return [d - l - p + r, a - c - h - u + o, d - l + r, a - c - h + o];
            default:
    ...
    static deserialize(t, e, i) {
        ...
        const [n, a] = s.pageDimensions, [r, o, h, l] = s.getRectInCurrentCoords(t.rect, a);
        s.x = r / n;
        s.y = o / a;
        s.width = h / n;
        s.height = l / a;
    ...
    keydown(t) {
        ...
        this.#Xt = {savedX: this.x, savedY: this.y, savedWidth: this.width, savedHeight: this.height};
        const e = this.#qt.children;
        if (!this.#Vt) {
            this.#Vt = Array.from(e);
            const t = this.#ye.bind(this), i = this.#we.bind(this);
        ...
        const n = (360 - this.rotation + this.parentRotation) % 360 / 90 * (this.#Vt.length / 4);
        if (n !== s) {
            if (n < s) for (let t = 0; t < s - n; t++) this.#qt.append(this.#qt.firstChild); else if (n > s) for (let t = 0; t < n - s; t++) this.#qt.firstChild.before(this.#qt.lastChild);
            let t = 0;
            for (const i of e) {
                const e = this.#Vt[t++].getAttribute("data-resizer-name");
    ...
    #Ee(t) {
        if (this.#Vt) for (const e of this.#Vt) e.tabIndex = t
    }
    ...
    select() {
        ...
        this.#Qt ? this.#Qt?.show() : this.addEditToolbar().then((() => {
...
class MurmurHash3_64 {
    ...
    update(t) {
        ...
        let r = 0, o = 0, h = this.h1, l = this.h2;
...
class AnnotationStorage {
    ...
    remove(t) {
        ...
        if ("function" == typeof this.onAnnotationEditor) {
            for (const t of this.#Ce.values()) if (t instanceof AnnotationEditor) return;
            this.onAnnotationEditor(null)
        }
    }
...
class PrintAnnotationStorage extends AnnotationStorage {
    ...
    constructor(t) {
        super();
        const {map: e, hash: i, transfer: s} = t.serializable, n = structuredClone(e, s ? {transfer: s} : null);
...
class FontLoader {
    ...
    _queueLoadingCallback(t) {
        const {loadingRequests: e} = this, i = {
            done: !1, complete: function completeRequest() {
    ...
    _prepareFontLoadEvent(t, e) {
        ...
        h = spliceString(h, 976, o.length, o);
        const l = 1482184792;
        let d = int32(h, 16);
        for (i = 0, s = o.length - 3; i < s; i += 4) d = d - l + int32(o, i) | 0;
        i < o.length && (d = d - l + int32(o + "XXX", i) | 0);
        h = spliceString(h, 16, 4, function string32(t) {
            return String.fromCharCode(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, 255 & t)
        }(d));
        const c = `@font-face {font-family:"${o}";src:${`url(data:font/opentype;base64,${btoa(h)});`}}`;
        this.insertRule(c);
    ...
    getPathGenerator(t, e) {
        ...
        for (let t = 0, e = i.length; t < e;) switch (i[t++]) {
            case it: {
                ...
                s.push((t => t.bezierCurveTo(e, n, a, r, o, h)));
                t += 6
            }
                break;
            case st: {
            ...
            case lt: {
                const [e, n, a, r, o, h] = i.slice(t, t + 6);
                s.push((t => t.transform(e, n, a, r, o, h)));
                t += 6
            }
                break;
            case dt: {
...
if (e) {
    ...
    (async () => {
        const t = await import("fs"), e = await import("http"), i = await import("https"), s = await import("url");
    ...
    getPattern(t, e, i, s) {
        ...
        if (s === yt || s === At) {
            const a = e.current.getClippedPathBoundingBox(s, getCurrentTransform(t)) || [0, 0, 0, 0],
                ...
                h = e.cachedCanvases.getCanvas("pattern", r, o, !0), l = h.context;
...
function drawTriangle(t, e, i, s, n, a, r, o) {
    const h = e.coords, l = e.colors, d = t.data, c = 4 * t.width;
    let u;
    if (h[i + 1] > h[s + 1]) {
        u = i;
        i = s;
    ...
    const p = (h[i] + e.offsetX) * e.scaleX, g = (h[i + 1] + e.offsetY) * e.scaleY, m = (h[s] + e.offsetX) * e.scaleX,
        f = (h[s + 1] + e.offsetY) * e.scaleY, b = (h[n] + e.offsetX) * e.scaleX, v = (h[n + 1] + e.offsetY) * e.scaleY;
    if (g >= v) return;
    const A = l[a], y = l[a + 1], w = l[a + 2], x = l[r], E = l[r + 1], _ = l[r + 2], C = l[o], S = l[o + 1],
        T = l[o + 2], M = Math.round(g), k = Math.round(v);
    let P, D, R, F, I, L, O, N;
    for (let t = M; t <= k; t++) {
        if (t < f) {
...
function drawFigure(t, e, i) {
    ...
    switch (e.type) {
        case"lattice":
            const o = e.verticesPerRow, h = Math.floor(s.length / o) - 1, l = o - 1;
            for (a = 0; a < h; a++) {
                let e = a * o;
                for (let a = 0; a < l; a++, e++) {
...
class MeshShadingPattern extends BaseShadingPattern {
    ...
    _createMeshCanvas(t, e, i) {
        const s = Math.floor(this._bounds[0]), n = Math.floor(this._bounds[1]), a = Math.ceil(this._bounds[2]) - s,
            r = Math.ceil(this._bounds[3]) - n, o = Math.min(Math.ceil(Math.abs(a * t[0] * 1.1)), 3e3),
            h = Math.min(Math.ceil(Math.abs(r * t[1] * 1.1)), 3e3), l = a / o, d = r / h,
            c = {coords: this._coords, colors: this._colors, offsetX: -s, offsetY: -n, scaleX: 1 / l, scaleY: 1 / d},
            u = o + 4, p = h + 4, g = i.getCanvas("mesh", u, p, !1), m = g.context, f = m.createImageData(o, h);
        if (e) {
            const t = f.data;
        ...
        return {canvas: g.canvas, offsetX: s - 2 * l, offsetY: n - 2 * d, scaleX: l, scaleY: d}
    }

    getPattern(t, e, i, s) {
        applyBoundingBox(t, this._bbox);
        let n;
        if (s === wt) n = Util.singularValueDecompose2dScale(getCurrentTransform(t)); else {
...
class TilingPattern {
    ...
    createPatternCanvas(t) {
        const e = this.operatorList, i = this.bbox, s = this.xstep, n = this.ystep, a = this.paintType,
            r = this.tilingType, o = this.color, h = this.canvasGraphicsFactory;
        info("TilingType: " + r);
        const l = i[0], d = i[1], c = i[2], u = i[3], p = Util.singularValueDecompose2dScale(this.matrix),
            g = Util.singularValueDecompose2dScale(this.baseTransform), m = [p[0] * g[0], p[1] * g[1]],
            f = this.getSizeAndScale(s, this.ctx.canvas.width, m[0]),
            b = this.getSizeAndScale(n, this.ctx.canvas.height, m[1]),
            v = t.cachedCanvases.getCanvas("pattern", f.size, b.size, !0), A = v.context, y = h.createCanvasGraphics(A);
        ...
        y.endDrawing();
        return {canvas: v.canvas, scaleX: f.scale, scaleY: b.scale, offsetX: w, offsetY: x}
    }
...
function convertBlackAndWhiteToRGBA({
    ...
    const o = util_FeatureTest.isLittleEndian ? 4278190080 : 255, [h, l] = r ? [a, o] : [o, a], d = s >> 3, c = 7 & s,
        u = t.length;
    ...
    for (let s = 0; s < n; s++) {
        ...
        if (0 === c) continue;
        const s = e < u ? t[e++] : 255;
        for (let t = 0; t < c; t++) i[p++] = s & 1 << 7 - t ? l : h
    }
...
function drawImageAtIntegerCoords(t, e, i, s, n, a, r, o, h, l) {
    const [d, c, u, p, g, m] = getCurrentTransform(t);
    if (0 === c && 0 === u) {
        const f = r * d + g, b = Math.round(f), v = o * p + m, A = Math.round(v), y = (r + h) * d + g,
            w = Math.abs(Math.round(y) - b) || 1, x = (o + l) * p + m, E = Math.abs(Math.round(x) - A) || 1;
    ...
    if (0 === d && 0 === p) {
        const f = o * u + g, b = Math.round(f), v = r * c + m, A = Math.round(v), y = (o + l) * u + g,
            w = Math.abs(Math.round(y) - b) || 1, x = (r + h) * c + m, E = Math.abs(Math.round(x) - A) || 1;
    ...
    return [Math.hypot(d, c) * h, Math.hypot(u, p) * l]
}
...
class CanvasExtraState {
    ...
    updateRectMinMax(t, e) {
        const i = Util.applyTransform(e, t), s = Util.applyTransform(e.slice(2), t),
            n = Util.applyTransform([e[0], e[3]], t), a = Util.applyTransform([e[2], e[1]], t);
    ...
    updateCurvePathMinMax(t, e, i, s, n, a, r, o, h, l) {
        const d = Util.bezierBoundingBox(e, i, s, n, a, r, o, h, l);
        l || this.updateRectMinMax(t, d)
    }
    ...
    getPathBoundingBox(t = At, e = null) {
        ...
        if (t === yt) {
            ...
            const t = Util.singularValueDecompose2dScale(e), s = t[0] * this.lineWidth / 2,
...
function putBinaryImageData(t, e) {
    ...
    const i = e.height, s = e.width, n = i % _t, a = (i - n) / _t, r = 0 === n ? a : a + 1,
        o = t.createImageData(s, _t);
    let h, l = 0;
    const d = e.data, c = o.data;
    let u, p, g, m;
    if (e.kind === x.GRAYSCALE_1BPP) {
        const e = d.byteLength, i = new Uint32Array(c.buffer, 0, c.byteLength >> 2), m = i.length, f = s + 7 >> 3,
            b = 4294967295, v = util_FeatureTest.isLittleEndian ? 4278190080 : 255;
        for (u = 0; u < r; u++) {
            g = u < a ? _t : n;
            h = 0;
            for (p = 0; p < g; p++) {
...
function putBinaryImageMask(t, e) {
    ...
    const i = e.height, s = e.width, n = i % _t, a = (i - n) / _t, r = 0 === n ? a : a + 1,
        o = t.createImageData(s, _t);
    let h = 0;
    const l = e.data, d = o.data;
    for (let e = 0; e < r; e++) {
        const i = e < a ? _t : n;
        ({srcPos: h} = convertBlackAndWhiteToRGBA({src: l, srcPos: h, dest: d, width: s, height: i, nonBlackColor: 0}));
...
const Ct = ["butt", "round", "square"], St = ["miter", "round", "bevel"], Tt = {}, Mt = {};

class CanvasGraphics {
    constructor(t, e, i, s, n, {optionalContentConfig: a, markedContentStack: r = null}, o, h) {
        this.ctx = t;
    ...
    executeOperatorList(t, e, i, s) {
        ...
        const o = n.length;
        if (o === r) return r;
        const h = o - r > 10 && "function" == typeof i, l = h ? Date.now() + 15 : 0;
        let d = 0;
        ...
        for (; ;) {
            ...
            p = a[r];
            if (p !== X.dependency) this[p].apply(this, n[r]); else for (const t of n[r]) {
    ...
    _scaleImage(t, e) {
        ...
        let n, a, r = Math.max(Math.hypot(e[0], e[1]), 1), o = Math.max(Math.hypot(e[2], e[3]), 1), h = i, l = s,
            d = "prescale1";
        for (; r > 2 && h > 1 || o > 2 && l > 1;) {
            let e = h, i = l;
            if (r > 2 && h > 1) {
    ...
    _createMaskCanvas(t) {
        const e = this.ctx, {width: i, height: s} = t, n = this.current.fillColor, a = this.current.patternFill,
        ...
        const [u, p, g, m] = Util.getAxialAlignedBoundingBox([0, 0, i, s], c), f = Math.round(g - u) || 1,
            b = Math.round(m - p) || 1, v = this.cachedCanvases.getCanvas("fillCanvas", f, b), A = v.context, y = u,
            w = p;
        A.translate(-y, -w);
        A.transform(...c);
        if (!l) {
            l = this._scaleImage(d.canvas, getCurrentTransformInverse(A));
            l = l.img;
            o && a && o.set(h, l)
        }
        A.imageSmoothingEnabled = getImageSmoothingEnabled(getCurrentTransform(A), t.interpolate);
        drawImageAtIntegerCoords(A, l, 0, 0, l.width, l.height, 0, 0, i, s);
        A.globalCompositeOperation = "source-in";
        const x = Util.transform(getCurrentTransformInverse(A), [1, 0, 0, 1, -y, -w]);
    ...
    beginSMaskMode() {
        ...
        const t = this.ctx.canvas.width, e = this.ctx.canvas.height, i = "smaskGroupAt" + this.groupLevel,
    ...
    genericComposeSMask(t, e, i, s, n, a, r, o, h, l, d) {
        let c = t.canvas, u = o - l, p = h - d;
        if (a) if (u < 0 || p < 0 || u + i > c.width || p + s > c.height) {
    ...
    constructPath(t, e, i) {
        ...
        let a, r, o = n.x, h = n.y;
        const l = getCurrentTransform(s), d = 0 === l[0] && 0 === l[3] || 0 === l[1] && 0 === l[2],
            c = d ? i.slice(0) : null;
        for (let i = 0, u = 0, p = t.length; i < p; i++) switch (0 | t[i]) {
            case X.rectangle:
                o = e[u++];
                h = e[u++];
                const t = e[u++], i = e[u++], p = o + t, g = h + i;
                s.moveTo(o, h);
                if (0 === t || 0 === i) s.lineTo(p, g); else {
                    s.lineTo(p, h);
                    s.lineTo(p, g);
                    s.lineTo(o, g)
                }
                d || n.updateRectMinMax(l, [o, h, p, g]);
                s.closePath();
                break;
            case X.moveTo:
                o = e[u++];
            ...
            case X.curveTo:
                ...
                n.updateCurvePathMinMax(l, a, r, e[u], e[u + 1], e[u + 2], e[u + 3], o, h, c);
                u += 6;
                break;
            case X.curveTo2:
                a = o;
                ...
                n.updateCurvePathMinMax(l, a, r, o, h, e[u], e[u + 1], e[u + 2], e[u + 3], c);
                o = e[u + 2];
                h = e[u + 3];
                u += 4;
                break;
            case X.curveTo3:
                ...
                n.updateCurvePathMinMax(l, a, r, e[u], e[u + 1], o, h, o, h, c);
                u += 4;
                break;
            case X.closePath:
                s.closePath()
        }
        d && n.updateScalingPathMinMax(l, c);
        n.setCurrentPoint(o, h)
    }
    ...
    paintChar(t, e, i, s) {
        const n = this.ctx, a = this.current, r = a.font, o = a.textRenderingMode, h = a.fontSize / a.fontSizeScale,
            l = o & y, d = !!(o & w), c = a.patternFill && !r.missingFile;
        let u;
        ...
        if (r.disableFontFace || c) {
            ...
            l !== f && l !== v || n.fillText(t, e, i);
            l !== b && l !== v || n.strokeText(t, e, i)
        }
        if (d) {
    ...
    showText(t) {
        ...
        const s = e.fontSize;
        if (0 === s) return;
        const n = this.ctx, a = e.fontSizeScale, r = e.charSpacing, o = e.wordSpacing, h = e.fontDirection,
            l = e.textHScale * h, d = t.length, c = i.vertical, u = c ? 1 : -1, p = i.defaultVMetrics,
            g = s * e.fontMatrix[0], m = e.textRenderingMode === f && !i.disableFontFace && !e.patternFill;
        n.save();
        ...
        for (E = 0; E < d; ++E) {
            ...
            if (this.contentVisible && (e.isInFont || i.missingFile)) if (m && !b) n.fillText(f, v, y); else {
    ...
    showType3Text(t) {
        const e = this.ctx, i = this.current, n = i.font, a = i.fontSize, r = i.fontDirection, o = n.vertical ? 1 : -1,
            h = i.charSpacing, l = i.wordSpacing, d = i.textHScale * r, c = i.fontMatrix || s, u = t.length;
        let p, g, m, f;
        if (!(i.textRenderingMode === A) && 0 !== a) {
            ...
            for (p = 0; p < u; ++p) {
                ...
                const s = (g.isSpace ? l : 0) + h, r = n.charProcOperatorList[g.operatorListId];
                if (!r) {
    ...
    shadingFill(t) {
        ...
        if (s) {
            const {width: t, height: i} = e.canvas, [n, a, r, o] = Util.getAxialAlignedBoundingBox([0, 0, t, i], s);
    ...
    beginGroup(t) {
        ...
        const a = Math.floor(s[0]), r = Math.floor(s[1]), o = Math.max(Math.ceil(s[2]) - a, 1),
        ...
        const d = this.cachedCanvases.getCanvas(l, o, h), c = d.context;
        c.translate(-a, -r);
        c.transform(...i);
    ...
    beginAnnotation(t, e, i, s, n) {
        ...
        if (e) {
            ...
            if (n && this.annotationCanvasMap) {
                ...
                e[2] = s;
                e[3] = a;
                const [n, r] = Util.singularValueDecompose2dScale(getCurrentTransform(this.ctx)), {viewportScale: o} = this,
                    h = Math.ceil(s * this.outputScaleX * o), l = Math.ceil(a * this.outputScaleY * o);
    ...
    paintImageMaskXObject(t) {
        ...
        if (s) {
            void 0 === s.compiled && (s.compiled = function compileType3Glyph(t) {
                ...
                const s = new Uint8Array([0, 2, 4, 0, 1, 0, 5, 4, 8, 10, 0, 8, 0, 2, 1, 0]), n = e + 1;
                let a, r, o, h = new Uint8Array(n * (i + 1));
                const l = e + 7 & -8;
                let d = new Uint8Array(l * i), c = 0;
                ...
                for (a = 1; a < i; a++) {
                    ...
                    let t = (d[c] ? 4 : 0) + (d[c - l] ? 8 : 0);
                    for (r = 1; r < e; r++) {
                        t = (t >> 2) + (d[c + 1] ? 4 : 0) + (d[c - l + 1] ? 8 : 0);
                        if (s[t]) {
                            h[o + r] = s[t];
                            ++u
                        }
    ...
    paintImageMaskXObjectRepeat(t, e, i = 0, s = 0, n, a) {
        ...
        for (let t = 0, l = a.length; t < l; t += 2) {
            const l = Util.transform(o, [e, i, s, n, a[t], a[t + 1]]), [d, c] = Util.applyTransform([0, 0], l);
            r.drawImage(h.canvas, d, c)
        }
        r.restore();
        this.compose()
    }
    ...
    paintImageMaskXObjectGroup(t) {
        ...
        for (const n of t) {
            const {data: t, width: a, height: r, transform: o} = n,
                h = this.cachedCanvases.getCanvas("maskCanvas", a, r), l = h.context;
            l.save();
            putBinaryImageMask(l, this.getObject(t, n));
            l.globalCompositeOperation = "source-in";
            l.fillStyle = s ? i.getPattern(l, this, getCurrentTransformInverse(e), At) : i;
            l.fillRect(0, 0, a, r);
            l.restore();
            e.save();
            e.transform(...o);
            e.scale(1, -1);
            drawImageAtIntegerCoords(e, h.canvas, 0, 0, a, r, 0, -1, 1, 1);
            e.restore()
        }
        this.compose()
    }
    ...
    applyTransferMapsToBitmap(t) {
        ...
        const {bitmap: e, width: i, height: s} = t, n = this.cachedCanvases.getCanvas("inlineImage", i, s),
            a = n.context;
    ...
    getScaleForStroking() {
        if (-1 === this._cachedScaleForStroking[0]) {
            ...
            if (0 === i && 0 === s) {
                ...
                const o = Math.abs(e * n - i * s), h = Math.hypot(e, i), l = Math.hypot(s, n);
                if (0 === t) {
                    a = l / o;
                    r = h / o
                } else {
...
const kt = 1, Pt = 2, Dt = 1, Rt = 2, Ft = 3, It = 4, Lt = 5, Ot = 6, Nt = 7, Bt = 8;
...
class MessageHandler {
    constructor(t, e, i) {
        ...
        this._onComObjOnMessage = t => {
            ...
            if (e.callback) {
                ...
                if (e.callback === kt) i.resolve(e.data); else {
            ...
            if (e.callbackId) {
                ...
                new Promise((function (t) {
                    ...
                    i.postMessage({sourceName: t, targetName: n, callback: kt, callbackId: e.callbackId, data: s})
                }), (function (s) {
                    i.postMessage({
                        sourceName: t,
                        targetName: n,
    ...
    #Ie(t) {
        const e = t.streamId, i = this.sourceName, s = t.sourceName, n = this.comObj, a = this,
            r = this.actionHandler[t.action], o = {
                enqueue(t, a = 1, r) {
                    ...
                    n.postMessage({sourceName: i, targetName: s, stream: It, streamId: e, chunk: t}, r)
                },
                close() {
                    if (!this.isCancelled) {
                        this.isCancelled = !0;
                        n.postMessage({sourceName: i, targetName: s, stream: Ft, streamId: e});
                ...
                error(t) {
                    ...
                    if (!this.isCancelled) {
                        this.isCancelled = !0;
                        n.postMessage({sourceName: i, targetName: s, stream: Lt, streamId: e, reason: wrapReason(t)})
                    }
                },
    ...
    #Fe(t) {
        const e = t.streamId, i = this.sourceName, s = t.sourceName, n = this.comObj, a = this.streamControllers[e],
...
class OptionalContentGroup {
    ...
    get visible() {
        if (this.#ze) return this.#Ue;
        if (!this.#Ue) return !1;
        const {print: t, view: e} = this.usage;
        return this.#Be ? "OFF" !== e?.viewState : !this.#He || "OFF" !== t?.printState
    }
...
class OptionalContentConfig {
    ...
    constructor(t, e = r) {
        ...
        if (null !== t) {
            ...
            this.#Ge = t.order;
            for (const i of t.groups) this.#$e.set(i.id, new OptionalContentGroup(e, i));
            if ("OFF" === t.baseState) for (const t of this.#$e.values()) t._setVisible(Ht, !1);
            for (const e of t.on) this.#$e.get(e)._setVisible(Ht, !0);
            for (const e of t.off) this.#$e.get(e)._setVisible(Ht, !1);
            this.#Ve = this.getHash()
        }
    }
    ...
    #We(t) {
        ...
        for (let s = 1; s < e; s++) {
            const e = t[s];
            let n;
            if (Array.isArray(e)) n = this.#We(e); else {
                if (!this.#$e.has(e)) {
                    warn(`Optional content group not found: ${e}`);
                    return !0
                }
                n = this.#$e.get(e).visible
            }
            switch (i) {
                case"And":
                    if (!n) return !1;
    ...
    isVisible(t) {
        ...
        if ("OCG" === t.type) {
            ...
            return this.#$e.get(t.id).visible
        }
        if ("OCMD" === t.type) {
            if (t.expression) return this.#We(t.expression);
    ...
    get hasInitialVisibility() {
        return null === this.#Ve || this.getHash() === this.#Ve
    }

    getOrder() {
        return this.#$e.size ? this.#Ge ? this.#Ge.slice() : [...this.#$e.keys()] : null
    }

    getGroups() {
        return this.#$e.size > 0 ? objectFromMap(this.#$e) : null
    }
...
function validateRangeRequestCapabilities({getResponseHeader: t, isHttp: e, rangeChunkSize: i, disableRange: s}) {
    const n = {allowRangeRequests: !1, suggestedLength: void 0}, a = parseInt(t("Content-Length"), 10);
        ...
        let t = function getFilenameFromContentDispositionHeader(t) {
            ...
            function textdecode(t, i) {
                if (t) {
                    ...
                    try {
                        const s = new TextDecoder(t, {fatal: !0}), n = stringToBytes(i);
                        i = s.decode(n);
                        e = !1
                    } catch {
                    }
...
class NetworkManager {
    ...
    request(t) {
        const e = new XMLHttpRequest, i = this.currXhrId++, s = this.pendingRequests[i] = {xhr: e};
        e.open("GET", this.url);
...
class TextLayer {
    ...
    constructor({textContentSource: t, container: e, viewport: i}) {
        if (t instanceof ReadableStream) this.#ri = t; else {
        ...
        this.#ii = i.rotation;
        this.#Qe = {prevFontSize: null, prevFontFamily: null, div: null, properties: null, ctx: null};
        const {pageWidth: s, pageHeight: n, pageX: a, pageY: r} = i.rawDims;
        this.#li = [1, 0, 0, -1, -a, r + n];
        this.#Ze = s;
        this.#Je = n;
        setLayerDimensions(e, i);
        this.#qe.promise.catch((() => {
        })).then((() => {
    ...
    #fi(t) {
        ...
        this.#oi.push(e);
        const s = Util.transform(this.#li, t.transform);
        let n = Math.atan2(s[1], s[0]);
        const a = this.#ni[t.fontName];
        a.vertical && (n += Math.PI / 2);
        const r = this.#Ke && a.fontSubstitution || a.fontFamily, o = Math.hypot(s[2], s[3]),
            h = o * TextLayer.#bi(r, this.#Ye);
        let l, d;
        if (0 === n) {
            l = s[4];
            d = s[5] - h
        ...
        if (this.#ft === this.#ei) {
            u.left = `${(100 * l / this.#Ze).toFixed(2)}%`;
            u.top = `${(100 * d / this.#Je).toFixed(2)}%`
        } else {
            u.left = `${c}${l.toFixed(2)}px)`;
        ...
        e.textContent = t.str;
        e.dir = t.dir;
        this.#Ke && (e.dataset.fontName = a.fontSubstitutionLoadedName || t.fontName);
    ...
    #mi(t) {
        ...
        if (0 !== i.canvasWidth && i.hasText) {
            const {fontFamily: h} = r, {canvasWidth: l, fontSize: d} = i;
            if (n !== d || a !== h) {
                s.font = `${d * this.#si}px ${h}`;
                t.prevFontSize = d;
                t.prevFontFamily = h
            }
            const {width: c} = s.measureText(e.textContent);
            c > 0 && (o = `scaleX(${l * this.#si / c})`)
        }
    ...
    static #bi(t, e) {
        ...
        s.strokeText("g", 0, 0);
        let h = s.getImageData(0, 0, Ut, Ut).data;
        o = 0;
        ...
        s.clearRect(0, 0, Ut, Ut);
        s.strokeText("A", 0, Ut);
        h = s.getImageData(0, 0, Ut, Ut).data;
        r = 0;
...
class XfaText {
    static textContent(t) {
        const e = [], i = {items: e, styles: Object.create(null)};
        !function walk(t) {
            if (!t) return;
            let i = null;
            const s = t.name;
...
const jt = 65536, $t = e ? class NodeCanvasFactory extends BaseCanvasFactory {
...
} : DOMCMapReaderFactory, Gt = e ? class NodeFilterFactory extends BaseFilterFactory {
    ...
    get #_i() {
        if (!this.#Ai) {
            const t = this.#wi.createElement("div"), {style: e} = t;
            e.visibility = "hidden";
            e.contain = "strict";
            e.width = e.height = 0;
            e.position = "absolute";
    ...
    addFilter(t) {
        ...
        let e = this.#v.get(t);
        if (e) return e;
        const [i, s, n] = this.#Ci(t), a = 1 === t.length ? i : `${i}${s}${n}`;
        e = this.#v.get(a);
        if (e) {
            this.#v.set(t, e);
            return e
        }
        const r = `g_${this.#yi}_transfer_map_${this.#f++}`, o = `url(#${r})`;
        this.#v.set(t, o);
        this.#v.set(a, o);
        const h = this.#Si(r);
        this.#Ti(i, s, n, h);
    ...
    addHCMFilter(t, e) {
        ...
        const h = o.join(","), l = `g_${this.#yi}_hcm_filter`, d = n.filter = this.#Si(l);
        this.#Ti(h, h, h, d);
        this.#ki(d);
        const getSteps = (t, e) => {
    ...
    addAlphaFilter(t) {
        let e = this.#v.get(t);
        if (e) return e;
        const [i] = this.#Ci([t]), s = `alpha_${i}`;
        e = this.#v.get(s);
        if (e) {
            this.#v.set(t, e);
            return e
        }
        const n = `g_${this.#yi}_alpha_map_${this.#f++}`, a = `url(#${n})`;
        this.#v.set(t, a);
        this.#v.set(s, a);
        const r = this.#Si(n);
        this.#Pi(i, r);
    ...
    addLuminosityFilter(t) {
        ...
        const n = `g_${this.#yi}_luminosity_map_${this.#f++}`, a = `url(#${n})`;
        this.#v.set(t, a);
        this.#v.set(i, a);
        const r = this.#Si(n);
        this.#Di(r);
    ...
    addHighlightHCMFilter(t, e, i, s, n) {
        ...
        if (!e || !i) return r.url;
        const [o, h] = [e, i].map(this.#Mi.bind(this));
        let l = Math.round(.2126 * o[0] + .7152 * o[1] + .0722 * o[2]),
            d = Math.round(.2126 * h[0] + .7152 * h[1] + .0722 * h[2]), [c, u] = [s, n].map(this.#Mi.bind(this));
        d < l && ([l, d, c, u] = [d, l, u, c]);
        this.#_i.style.color = "";
        const getSteps = (t, e, i) => {
            const s = new Array(256), n = (d - l) / i, a = t / 255, r = (e - t) / (255 * i);
            let o = 0;
            for (let t = 0; t <= i; t++) {
                const e = Math.round(l + t * n), i = a + t * r;
                for (let t = o; t <= e; t++) s[t] = i;
                o = e + 1
            }
            for (let t = o; t < 256; t++) s[t] = s[o - 1];
            return s.join(",")
        }, p = `g_${this.#yi}_hcm_${t}_filter`, g = r.filter = this.#Si(p);
        this.#ki(g);
        this.#Ti(getSteps(c[0], u[0], 5), getSteps(c[1], u[1], 5), getSteps(c[2], u[2], 5), g);
        r.url = `url(#${p})`;
        return r.url
    }
...
}, Wt = e ? class NodeStandardFontDataFactory extends BaseStandardFontDataFactory {
    _fetchData(t) {
...
function getDocument(t) {
    ...
    const i = new PDFDocumentLoadingTask, {docId: s} = i, n = t.url ? function getUrlProp(t) {
        ...
        }(t.data) : null, r = t.httpHeaders || null, o = !0 === t.withCredentials, h = t.password ?? null,
        l = t.range instanceof PDFDataRangeTransport ? t.range : null,
        d = Number.isInteger(t.rangeChunkSize) && t.rangeChunkSize > 0 ? t.rangeChunkSize : jt;
    let c = t.worker instanceof PDFWorker ? t.worker : null;
    const u = t.verbosity, p = "string" != typeof t.docBaseUrl || isDataScheme(t.docBaseUrl) ? null : t.docBaseUrl,
        g = "string" == typeof t.cMapUrl ? t.cMapUrl : null, m = !1 !== t.cMapPacked, f = t.CMapReaderFactory || Vt,
        b = "string" == typeof t.standardFontDataUrl ? t.standardFontDataUrl : null,
        v = t.StandardFontDataFactory || Wt, A = !0 !== t.stopAtErrors,
        y = Number.isInteger(t.maxImageSize) && t.maxImageSize > -1 ? t.maxImageSize : -1, w = !1 !== t.isEvalSupported,
        ...
        _ = "boolean" == typeof t.disableFontFace ? t.disableFontFace : e, C = !0 === t.fontExtraProperties,
        S = !0 === t.enableXfa, T = t.ownerDocument || globalThis.document, M = !0 === t.disableRange,
        k = !0 === t.disableStream, P = !0 === t.disableAutoFetch, D = !0 === t.pdfBug,
        R = l ? l.length : t.length ?? NaN, F = "boolean" == typeof t.useSystemFonts ? t.useSystemFonts : !e && !_,
        I = "boolean" == typeof t.useWorkerFetch ? t.useWorkerFetch : f === DOMCMapReaderFactory && v === DOMStandardFontDataFactory && g && b && isValidFetchUrl(g, document.baseURI) && isValidFetchUrl(b, document.baseURI),
        L = t.canvasFactory || new $t({ownerDocument: T}), O = t.filterFactory || new Gt({docId: s, ownerDocument: T});
    setVerbosityLevel(u);
    ...
    c.promise.then((function () {
        ...
        const t = c.messageHandler.sendWithPromise("GetDocRequest", B, a ? [a.buffer] : null);
        let h;
        if (l) h = new PDFDataTransportStream(l, {disableRange: M, disableStream: k}); else if (!a) {
            h = (t => {
                if (e) {
                    return function () {
        ...
        return t.then((t => {
            if (i.destroyed) throw new Error("Loading aborted");
            if (c.destroyed) throw new Error("Worker was destroyed");
            const e = new MessageHandler(s, t, c.port), n = new WorkerTransport(e, i, h, H, N);
            i._transport = n;
            e.send("Ready", null)
        }))
...
class PDFPageProxy {
    ...
    render({
        ...
        const complete = t => {
            ...
            if (t) {
                ...
                this._abortOperatorList({intentState: m, reason: t instanceof Error ? t : new Error(t)})
        ...
        const v = b.task;
        Promise.all([m.displayReadyCapability.promise, r]).then((([t, e]) => {
    ...
    getTextContent(t = {}) {
        ...
        return new Promise((function (t, i) {
            const s = e.getReader(), n = {items: [], styles: Object.create(null), lang: null};
            !function pump() {
...
class PDFWorker {
    ...
    constructor({name: t = null, port: e = null, verbosity: i = getVerbosityLevel()} = {}) {
        ...
        if (e) {
            if (PDFWorker.#Hi?.has(e)) throw new Error("Cannot use more than one PDFWorker per port.");
...
class WorkerTransport {
    ...
    getRenderingIntent(t, e = u.ENABLE, i = null, s = !1) {
        ...
        s && (n += c);
        return {renderingIntent: n, cacheKey: `${n}_${p.hash}`, annotationStorageSerializable: p}
    }
    ...
    destroy() {
        ...
        this.#Gi?.reject(new Error("Worker was destroyed during onPassword callback"));
        const t = [];
        ...
        t.on("PasswordRequest", (t => {
            ...
            if (e.onPassword) {
                const updatePassword = t => {
                    t instanceof Error ? this.#Gi.reject(t) : this.#Gi.resolve({password: t})
                };
                try {
            ...
            switch (i) {
                case"Font":
                    ...
                    const o = r && globalThis.FontInspector?.enabled ? (t, e) => globalThis.FontInspector.fontAdded(t, e) : null,
                        h = new FontFaceObject(s, {disableFontFace: n, inspectFont: o});
                    this.fontLoader.bind(h).catch((() => t.sendWithPromise("FontFallback", {id: e}))).finally((() => {
                ...
                case"CopyLocalImage":
                    const {imageRef: l} = s;
                    assert(l, "The imageRef must be defined.");
                    for (const t of this.#ji.values()) for (const [, i] of t.objs) if (i?.ref === l) {
    ...
    getFieldObjects() {
        return this.#Wi("GetFieldObjects")
    }

    hasJSActions() {
        return this.#Wi("HasJSActions")
    }
    ...
    getDocJSActions() {
        return this.#Wi("GetDocJSActions")
    }
    ...
    getOptionalContentConfig(t) {
        return this.#Wi("GetOptionalContentConfig").then((e => new OptionalContentConfig(e, t)))
    }
    ...
    getMetadata() {
        const t = "GetMetadata", e = this.#Ui.get(t);
        if (e) return e;
...
class PDFObjects {
    ...
    #Xi(t) {
        return this.#qi[t] ||= {...Promise.withResolvers(), data: Xt}
    }
    ...
    clear() {
        for (const t in this.#qi) {
            const {data: e} = this.#qi[t];
            e?.bitmap?.close()
        }
        this.#qi = Object.create(null)
    }
...
class RenderTask {
    ...
    get promise() {
        return this.#Ki.capability.promise
    }

    cancel(t = 0) {
        this.#Ki.cancel(null, t)
    }

    get separateAnnots() {
        const {separateAnnots: t} = this.#Ki.operatorList;
        if (!t) return !1;
        const {annotationCanvasMap: e} = this.#Ki;
        return t.form || t.canvas && e?.size > 0
    }
}

class InternalRenderTask {
    static#Yi = new WeakSet;
    ...
    initializeGraphics({transparency: t = !1, optionalContentConfig: e}) {
        ...
        if (this._canvas) {
            if (InternalRenderTask.#Yi.has(this._canvas)) throw new Error("Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.");
            InternalRenderTask.#Yi.add(this._canvas)
        }
    ...
    cancel(t = null, e = 0) {
        ...
        this.cancelled = !0;
        this.gfx?.endDrawing();
        InternalRenderTask.#Yi.delete(this._canvas);
...
class XfaLayer {
    ...
    static render(t) {
        const e = t.annotationStorage, i = t.linkService, s = t.xfaHtml, n = t.intent || "display",
        ...
        if (0 === s.children.length) {
            if (s.value) {
                ...
                a.append(t);
                r && XfaText.shouldBuildText(s.name) && h.push(t)
            }
            return {textDivs: h}
        }
        const l = [[s, -1, a]];
        for (; l.length > 0;) {
            ...
            if (o.children?.length > 0) l.push([o, -1, c]); else if (o.value) {
                const t = document.createTextNode(o.value);
                r && XfaText.shouldBuildText(d) && h.push(t);
                c.append(t)
            }
        }
...
class AnnotationElement {
    ...
    updateEdited(t) {
        ...
        this.#Qi ||= {rect: this.data.rect.slice(0)};
        const {rect: e} = t;
        e && this.#ts(e);
        this.#Zi?.popup.updateEdited(t)
    }

    resetEdited() {
        if (this.#Qi) {
            this.#ts(this.#Qi.rect);
            this.#Zi?.popup.resetEdited();
            this.#Qi = null
        }
    }
    ...
    #ts(t) {
        const {
            ...
            parent: {viewport: {rawDims: {pageWidth: n, pageHeight: a, pageX: r, pageY: o}}}
        } = this;
        i?.splice(0, 4, ...t);
        const {width: h, height: l} = getRectDims(t);
        e.left = 100 * (t[0] - r) / n + "%";
        e.top = 100 * (a - t[3] + o) / a + "%";
        if (0 === s) {
            e.width = 100 * h / n + "%";
    ...
    _createContainer(t) {
        ...
        const h = Util.normalizeRect([e.rect[0], i.view[3] - e.rect[1] + i.view[1], e.rect[2], i.view[3] - e.rect[3] + i.view[1]]), {
            pageWidth: l,
            pageHeight: d,
            pageX: c,
            pageY: u
    ...
    _createQuadrilaterals() {
        ...
        const o = s - e, h = n - i, {svgFactory: l} = this, d = l.createElement("svg");
        d.classList.add("quadrilateralsContainer");
        d.setAttribute("width", 0);
        d.setAttribute("height", 0);
        const c = l.createElement("defs");
        d.append(c);
        const u = l.createElement("clipPath"), p = `clippath_${this.data.id}`;
        u.setAttribute("id", p);
        u.setAttribute("clipPathUnits", "objectBoundingBox");
        c.append(u);
        for (const [, {x: i, y: s}, {x: a, y: d}] of t) {
            const t = l.createElement("rect"), c = (a - e) / o, p = (n - s) / h, g = (i - a) / o, m = (s - d) / h;
            t.setAttribute("x", c);
            t.setAttribute("y", p);
    ...
    _createPopup() {
        ...
        const i = this.#Zi = new PopupAnnotationElement({
            data: {
                color: e.color,
                titleObj: e.titleObj,
...
class LinkAnnotationElement extends AnnotationElement {
    ...
    render() {
        ...
        if (t.url) {
            ...
            this.#es(i, t.attachment, t.attachmentDest);
            s = !0
        } else if (t.setOCGState) {
            this.#is(i, t.setOCGState);
            s = !0
        } else if (t.dest) {
...
class WidgetAnnotationElement extends AnnotationElement {
    ...
    _setTextStyle(t) {
        const e = ["left", "center", "right"], {fontColor: i} = this.data.defaultAppearanceData,
            s = this.data.defaultAppearanceData.fontSize || 9, a = t.style;
        let r;
...
class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
    ...
    render() {
        ...
        const t = this.annotationStorage, e = this.data.id, i = t.getValue(e, {value: this.data.fieldValue}),
        ...
        if (this.enableScripting && this.hasJSActions) {
            s.addEventListener("updatefromsandbox", (i => {
                const n = {
                    value(i) {
                        a?.();
                        const n = i.detail.value, o = new Set(Array.isArray(n) ? n : [n]);
                        ...
                        const {index: n, displayValue: a, exportValue: o} = i.detail.insert, h = s.children[n],
                            l = document.createElement("option");
                        l.textContent = a;
                        l.value = o;
                        h ? h.before(l) : s.append(l);
                        t.setValue(e, {value: getValue(!0), items: getItems(i)});
                        r = getValue(!1)
                    }, items(i) {
...
class PopupElement {
    ...
    constructor({
        ...
        this.#bs = l;
        this.#ms = i;
        this.#gs = PDFDateString.toDateObject(n);
        this.trigger = i.flatMap((t => t.getElementsToTriggerPopup()));
        for (const t of this.trigger) {
            t.addEventListener("click", this.#ds);
            t.addEventListener("mouseenter", this.#hs);
            t.addEventListener("mouseleave", this.#rs);
            t.classList.add("popupTriggerArea")
        }
        for (const t of i) t.container?.addEventListener("keydown", this.#ns);
        this.#ft.hidden = !0;
        d && this.#cs()
    }
    ...
    render() {
        if (this.#As) return;
        const t = this.#As = document.createElement("div");
        t.className = "popup";
        if (this.#us) {
            const e = t.style.outlineColor = Util.makeHexColor(...this.#us);
            if (CSS.supports("background-color", "color-mix(in srgb, red 30%, white)")) t.style.backgroundColor = `color-mix(in srgb, ${e} 30%, white)`; else {
                const e = .7;
                t.style.backgroundColor = Util.makeHexColor(...this.#us.map((t => Math.floor(e * (255 - t) + t))))
            }
        }
        const e = document.createElement("span");
        e.className = "header";
        ...
        e.append(i);
        ({dir: i.dir, str: i.textContent} = this.#xs);
        t.append(e);
        if (this.#gs) {
            ...
            t.setAttribute("data-l10n-args", JSON.stringify({
                date: this.#gs.toLocaleDateString(),
                time: this.#gs.toLocaleTimeString()
            }));
            e.append(t)
        }
        const s = this.#_s;
        if (s) {
            ...
            const e = this._formatContents(this.#ps);
            t.append(e)
        }
        this.#ft.append(t)
    }
    ...
    get #_s() {
        const t = this.#ws, e = this.#ps;
        return !t?.str || e?.str && e.str !== t.str ? null : this.#ws.html || null
    }

    get #Cs() {
        return this.#_s?.attributes?.style?.fontSize || 0
    }

    get #Ss() {
        return this.#_s?.attributes?.style?.color || null
    }

    #Ts(t) {
        const e = [],
            i = {str: t, html: {name: "div", attributes: {dir: "auto"}, children: [{name: "p", children: e}]}},
            s = {style: {color: this.#Ss, fontSize: this.#Cs ? `calc(${this.#Cs}px * var(--scale-factor))` : ""}};
    ...
    #as(t) {
        t.altKey || t.shiftKey || t.ctrlKey || t.metaKey || ("Enter" === t.key || "Escape" === t.key && this.#vs) && this.#cs()
    }

    updateEdited({rect: t, popupContent: e}) {
        this.#Qi ||= {contentsObj: this.#ps, richText: this.#ws};
        t && (this.#E = null);
        if (e) {
            this.#ws = this.#Ts(e);
            this.#ps = null
    ...
    resetEdited() {
        if (this.#Qi) {
            ({contentsObj: this.#ps, richText: this.#ws} = this.#Qi);
            this.#Qi = null;
            this.#As?.remove();
            this.#As = null;
            this.#E = null
    ...
    #Ms() {
        ...
        const {page: {view: t}, viewport: {rawDims: {pageWidth: e, pageHeight: i, pageX: s, pageY: n}}} = this.#fs;
        let a = !!this.#bs, r = a ? this.#bs : this.#ys;
        for (const t of this.#ms) if (!r || null !== Util.intersect(t.data.rect, r)) {
            r = t.data.rect;
            a = !0;
            break
        }
        const o = Util.normalizeRect([r[0], t[3] - r[1] + t[1], r[2], t[3] - r[3] + t[1]]), h = a ? r[2] - r[0] + 5 : 0,
            l = o[0] + h, d = o[1];
        this.#E = [100 * (l - s) / e, 100 * (d - n) / i];
    ...
    #cs() {
        ...
        if (this.#vs) {
            this.#ls();
            this.#ft.addEventListener("click", this.#ds);
            this.#ft.addEventListener("keydown", this.#ns)
        } else {
            this.#os();
            this.#ft.removeEventListener("click", this.#ds);
            this.#ft.removeEventListener("keydown", this.#ns)
        }
    }

    #ls() {
        this.#As || this.render();
        if (this.isVisible) this.#vs && this.#ft.classList.add("focused"); else {
            this.#Ms();
            this.#ft.hidden = !1;
    ...
    forceHide() {
        this.#Es = this.isVisible;
        this.#Es && (this.#ft.hidden = !0)
    }
...
class LineAnnotationElement extends AnnotationElement {
    ...
    render() {
        ...
        const t = this.data, {width: e, height: i} = getRectDims(t.rect), s = this.svgFactory.create(e, i, !0),
            n = this.#ks = this.svgFactory.createElement("svg:line");
...
class SquareAnnotationElement extends AnnotationElement {
    ...
    render() {
        ...
        const t = this.data, {width: e, height: i} = getRectDims(t.rect), s = this.svgFactory.create(e, i, !0),
            n = t.borderStyle.width, a = this.#Ps = this.svgFactory.createElement("svg:rect");
...
class CircleAnnotationElement extends AnnotationElement {
    ...
    render() {
        ...
        const t = this.data, {width: e, height: i} = getRectDims(t.rect), s = this.svgFactory.create(e, i, !0),
            n = t.borderStyle.width, a = this.#Ds = this.svgFactory.createElement("svg:ellipse");
...
class FileAttachmentAnnotationElement extends AnnotationElement {
    ...
    render() {
        ...
        i.addEventListener("dblclick", this.#Ls.bind(this));
        this.#Is = i;
        const {isMac: s} = util_FeatureTest.platform;
        t.addEventListener("keydown", (t => {
            "Enter" === t.key && (s ? t.metaKey : t.ctrlKey) && this.#Ls()
        }));
...
class AnnotationLayer {
    ...
    #Hs(t, e) {
        ...
        i.id = `${et}${e}`;
        this.div.append(t);
        this.#Os?.moveElementInDOM(this.div, t, i, !1)
    }
    ...
    getEditableAnnotations() {
        return Array.from(this.#Bs.values())
    }
...
class FreeTextEditor extends AnnotationEditor {
    #Us = this.editorDivBlur.bind(this);
    #js = this.editorDivFocus.bind(this);
    #$s = this.editorDivInput.bind(this);
    #Vs = this.editorDivKeydown.bind(this);
    ...
    static get _keyboardManager() {
        const t = FreeTextEditor.prototype, arrowChecker = t => t.isEmpty(),
            e = AnnotationEditorUIManager.TRANSLATE_SMALL, i = AnnotationEditorUIManager.TRANSLATE_BIG;
        return shadow(this, "_keyboardManager", new KeyboardManager([[["ctrl+s", "mac+meta+s", "ctrl+p", "mac+meta+p"], t.commitOrRemove, {bubbles: !0}], [["ctrl+Enter", "mac+meta+Enter", "Escape", "mac+Escape"], t.commitOrRemove], [["ArrowLeft", "mac+ArrowLeft"], t._translateEmpty, {
            args: [-e, 0],
            checker: arrowChecker
    ...
    constructor(t) {
        ...
        this.#us = t.color || FreeTextEditor._defaultColor || AnnotationEditor._defaultLineColor;
        this.#Cs = t.fontSize || FreeTextEditor._defaultFontSize
    }
    ...
    static get defaultPropertiesToUpdate() {
        return [[g.FREETEXT_SIZE, FreeTextEditor._defaultFontSize], [g.FREETEXT_COLOR, FreeTextEditor._defaultColor || AnnotationEditor._defaultLineColor]]
    }

    get propertiesToUpdate() {
        return [[g.FREETEXT_SIZE, this.#Cs], [g.FREETEXT_COLOR, this.#us]]
    }

    #Ks(t) {
        const setFontsize = t => {
            this.editorDiv.style.fontSize = `calc(${t}px * var(--scale-factor))`;
            this.translate(0, -(t - this.#Cs) * this.parentScale);
            this.#Cs = t;
            this.#Qs()
        }, e = this.#Cs;
        this.addCommands({
    ...
    #Ys(t) {
        const setColor = t => {
            this.#us = this.editorDiv.style.color = t
        }, e = this.#us;
        this.addCommands({
    ...
    getInitialTranslation() {
        ...
        return [-FreeTextEditor._internalPadding * t, -(FreeTextEditor._internalPadding + this.#Cs) * t]
    }
    ...
    enableEditMode() {
        if (!this.isInEditMode()) {
            ...
            this.editorDiv.addEventListener("keydown", this.#Vs);
            this.editorDiv.addEventListener("focus", this.#js);
            this.editorDiv.addEventListener("blur", this.#Us);
    ...
    disableEditMode() {
        if (this.isInEditMode()) {
            ...
            this.div.setAttribute("aria-activedescendant", this.#qs);
            this._isDraggable = !0;
            this.editorDiv.removeEventListener("keydown", this.#Vs);
            this.editorDiv.removeEventListener("focus", this.#js);
            this.editorDiv.removeEventListener("blur", this.#Us);
    ...
    #Js() {
        ...
        for (const e of this.editorDiv.childNodes) t.push(FreeTextEditor.#Zs(e));
        return t.join("\n")
    }
    ...
    commit() {
        ...
        const t = this.#Ws, e = this.#Ws = this.#Js().trimEnd();
        if (t === e) return;
        const setText = t => {
            this.#Ws = t;
            if (t) {
    ...
    render() {
        ...
        this.editorDiv.setAttribute("id", this.#qs);
        ...
        i.fontSize = `calc(${this.#Cs}px * var(--scale-factor))`;
        i.color = this.#us;
        ...
        if (this.width) {
            ...
            if (this.annotationElementId) {
                const {position: n} = this.#Xs;
                let [a, r] = this.getInitialTranslation();
                [a, r] = this.pageTranslationToScreen(a, r);
                const [o, h] = this.pageDimensions, [l, d] = this.pageTranslation;
                let c, u;
                switch (this.rotation) {
                    case 0:
                        c = t + (n[0] - l) / o;
                        u = e + this.height - (n[1] - d) / h;
                        break;
                    case 90:
                        c = t + (n[0] - l) / o;
                        u = e - (n[1] - d) / h;
                        ...
                        break;
                    case 180:
                        c = t - this.width + (n[0] - l) / o;
                        u = e - (n[1] - d) / h;
                        [a, r] = [-a, -r];
                        break;
                    case 270:
                        c = t + (n[0] - l - this.height * h) / o;
                        u = e + (n[1] - d - this.width * o) / h;
                        [a, r] = [-r, a]
                }
    ...
    editorDivPaste(t) {
        ...
        t.preventDefault();
        const s = FreeTextEditor.#en(e.getData("text") || "").replaceAll(Zt, "\n");
        if (!s) return;
        ...
        const {startContainer: r, startOffset: o} = a, h = [], l = [];
        if (r.nodeType === Node.TEXT_NODE) {
            const t = r.parentElement;
            l.push(r.nodeValue.slice(o).replaceAll(Zt, ""));
            if (t !== this.editorDiv) {
                let e = h;
                for (const i of this.editorDiv.childNodes) i !== t ? e.push(FreeTextEditor.#Zs(i)) : e = l
            }
            h.push(r.nodeValue.slice(0, o).replaceAll(Zt, ""))
        } else if (r === this.editorDiv) {
            let t = h, e = 0;
            for (const i of this.editorDiv.childNodes) {
                e++ === o && (t = l);
                t.push(FreeTextEditor.#Zs(i))
            }
        }
        this.#Ws = `${h.join("\n")}${s}${l.join("\n")}`;
        this.#tn();
        const d = new Range;
        let c = h.reduce(((t, e) => t + e.length), 0);
    ...
    #tn() {
        ...
        if (this.#Ws) for (const t of this.#Ws.split("\n")) {
    ...
    static deserialize(t, e, i) {
        ...
        if (t instanceof FreeTextAnnotationElement) {
            const {
                data: {defaultAppearanceData: {fontSize: e, fontColor: i}, rect: n, rotation: a, id: r},
                textContent: o,
                textPosition: h,
                parent: {page: {pageNumber: l}}
            } = t;
        ...
        n.#Cs = t.fontSize;
        n.#us = Util.makeHexColor(...t.color);
        n.#Ws = FreeTextEditor.#en(t.value);
    ...
    serialize(t = !1) {
        ...
        const e = FreeTextEditor._internalPadding * this.parentScale, i = this.getRect(e, e),
            s = AnnotationEditor._colorManager.convert(this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#us),
            n = {
                annotationType: p.FREETEXT,
                color: s,
                fontSize: this.#Cs,
        ...
        if (t) return n;
        if (this.annotationElementId && !this.#sn(n)) return null;
        n.id = this.annotationElementId;
        return n
    }

    #sn(t) {
        const {value: e, fontSize: i, color: s, pageIndex: n} = this.#Xs;
    ...
    renderAnnotationElement(t) {
        ...
        t.updateEdited({rect: this.getRect(s, s), popupContent: this.#Ws});
        return e
    }
...
class Outliner {
    ...
    constructor(t, e = 0, i = 0, s = !0) {
        ...
        const h = 10 ** -4;
        for (const {x: i, y: s, width: l, height: d} of t) {
            const t = Math.floor((i - e) / h) * h, c = Math.ceil((i + l + e) / h) * h, u = Math.floor((s - e) / h) * h,
                p = Math.ceil((s + d + e) / h) * h, g = [t, u, p, !0], m = [c, u, p, !1];
            this.#an.push(g, m);
            n = Math.min(n, t);
            a = Math.max(a, c);
            r = Math.min(r, u);
        ...
        const l = a - n + 2 * i, d = o - r + 2 * i, c = n - i, u = r - i, p = this.#an.at(s ? -1 : -2),
            g = [p[0], p[2]];
        ...
        this.#nn = {x: c, y: u, width: l, height: d, lastPoint: g}
    }

    getOutlines() {
        this.#an.sort(((t, e) => t[0] - e[0] || t[1] - e[1] || t[2] - e[2]));
        const t = [];
        for (const e of this.#an) if (e[3]) {
            t.push(...this.#on(e));
            this.#hn(e)
        } else {
            this.#ln(e);
    ...
    #dn(t) {
        ...
        return new HighlightOutline(s, this.#nn)
    }
    ...
    #hn([, t, e]) {
        const i = this.#cn(t);
        this.#rn.splice(i, 0, [t, e])
    }

    #ln([, t, e]) {
        const i = this.#cn(t);
        for (let s = i; s < this.#rn.length; s++) {
            const [i, n] = this.#rn[s];
            if (i !== t) break;
            if (i === t && n === e) {
                this.#rn.splice(s, 1);
    ...
    #on(t) {
        const [e, i, s] = t, n = [[e, i, s]], a = this.#cn(s);
        for (let t = 0; t < a; t++) {
            const [i, s] = this.#rn[t];
            for (let t = 0, a = n.length; t < a; t++) {
                const [, r, o] = n[t];
                if (!(s <= r || o <= i)) if (r >= i) if (o > s) n[t][1] = s; else {
                    if (1 === a) return [];
                    n.splice(t, 1);
                    t--;
                    a--
...
class FreeOutliner {
    ...
    static#Cn = 8;
    static#Sn = 2;
    static#Tn = FreeOutliner.#Cn + FreeOutliner.#Sn;

    constructor({x: t, y: e}, i, s, n, a, r = 0) {
        this.#nn = i;
        this.#En = n * s;
        this.#mn = a;
        this.#bn.set([NaN, NaN, NaN, NaN, t, e], 6);
        this.#gn = r;
        this.#wn = FreeOutliner.#Cn * s;
        this.#yn = FreeOutliner.#Tn * s;
        this.#xn = s;
        this.#_n.push(t, e)
    }
    ...
    isEmpty() {
        return isNaN(this.#bn[8])
    }

    #Mn() {
        const t = this.#bn.subarray(4, 6), e = this.#bn.subarray(16, 18), [i, s, n, a] = this.#nn;
        return [(this.#vn + (t[0] - e[0]) / 2 - i) / n, (this.#An + (t[1] - e[1]) / 2 - s) / a, (this.#vn + (e[0] - t[0]) / 2 - i) / n, (this.#An + (e[1] - t[1]) / 2 - s) / a]
    }

    add({x: t, y: e}) {
        this.#vn = t;
        this.#An = e;
        const [i, s, n, a] = this.#nn;
        let [r, o, h, l] = this.#bn.subarray(8, 12);
        const d = t - h, c = e - l, u = Math.hypot(d, c);
        if (u < this.#yn) return !1;
        const p = u - this.#wn, g = p / u, m = g * d, f = g * c;
        let b = r, v = o;
        r = h;
        o = l;
        h += m;
        l += f;
        this.#_n?.push(t, e);
        const A = m / p, y = -f / p * this.#En, w = A * this.#En;
        this.#bn.set(this.#bn.subarray(2, 8), 0);
        this.#bn.set([h + y, l + w], 4);
        this.#bn.set(this.#bn.subarray(14, 18), 12);
        this.#bn.set([h - y, l - w], 16);
        if (isNaN(this.#bn[6])) {
            if (0 === this.#fn.length) {
                this.#bn.set([r + y, o + w], 2);
                this.#fn.push(NaN, NaN, NaN, NaN, (r + y - i) / n, (o + w - s) / a);
                this.#bn.set([r - y, o - w], 14);
                this.#pn.push(NaN, NaN, NaN, NaN, (r - y - i) / n, (o - w - s) / a)
            }
            this.#bn.set([b, v, r, o, h, l], 6);
            return !this.isEmpty()
        }
        this.#bn.set([b, v, r, o, h, l], 6);
        if (Math.abs(Math.atan2(v - o, b - r) - Math.atan2(f, m)) < Math.PI / 2) {
            [r, o, h, l] = this.#bn.subarray(2, 6);
            this.#fn.push(NaN, NaN, NaN, NaN, ((r + h) / 2 - i) / n, ((o + l) / 2 - s) / a);
            [r, o, b, v] = this.#bn.subarray(14, 18);
            this.#pn.push(NaN, NaN, NaN, NaN, ((b + r) / 2 - i) / n, ((v + o) / 2 - s) / a);
            return !0
        }
        [b, v, r, o, h, l] = this.#bn.subarray(0, 6);
        this.#fn.push(((b + 5 * r) / 6 - i) / n, ((v + 5 * o) / 6 - s) / a, ((5 * r + h) / 6 - i) / n, ((5 * o + l) / 6 - s) / a, ((r + h) / 2 - i) / n, ((o + l) / 2 - s) / a);
        [h, l, r, o, b, v] = this.#bn.subarray(12, 18);
        this.#pn.push(((b + 5 * r) / 6 - i) / n, ((v + 5 * o) / 6 - s) / a, ((5 * r + h) / 6 - i) / n, ((5 * o + l) / 6 - s) / a, ((r + h) / 2 - i) / n, ((o + l) / 2 - s) / a);
        return !0
    }

    toSVGPath() {
        if (this.isEmpty()) return "";
        const t = this.#fn, e = this.#pn, i = this.#bn.subarray(4, 6),
            s = this.#bn.subarray(16, 18), [n, a, r, o] = this.#nn, [h, l, d, c] = this.#Mn();
        if (isNaN(this.#bn[6]) && !this.isEmpty()) return `M${(this.#bn[2] - n) / r} ${(this.#bn[3] - a) / o} L${(this.#bn[4] - n) / r} ${(this.#bn[5] - a) / o} L${h} ${l} L${d} ${c} L${(this.#bn[16] - n) / r} ${(this.#bn[17] - a) / o} L${(this.#bn[14] - n) / r} ${(this.#bn[15] - a) / o} Z`;
        const u = [];
        u.push(`M${t[4]} ${t[5]}`);
        for (let e = 6; e < t.length; e += 6) isNaN(t[e]) ? u.push(`L${t[e + 4]} ${t[e + 5]}`) : u.push(`C${t[e]} ${t[e + 1]} ${t[e + 2]} ${t[e + 3]} ${t[e + 4]} ${t[e + 5]}`);
        u.push(`L${(i[0] - n) / r} ${(i[1] - a) / o} L${h} ${l} L${d} ${c} L${(s[0] - n) / r} ${(s[1] - a) / o}`);
    ...
    getOutlines() {
        const t = this.#fn, e = this.#pn, i = this.#bn, s = i.subarray(4, 6),
            n = i.subarray(16, 18), [a, r, o, h] = this.#nn, l = new Float64Array((this.#_n?.length ?? 0) + 2);
        for (let t = 0, e = l.length - 2; t < e; t += 2) {
            l[t] = (this.#_n[t] - a) / o;
            l[t + 1] = (this.#_n[t + 1] - r) / h
        }
        l[l.length - 2] = (this.#vn - a) / o;
        l[l.length - 1] = (this.#An - r) / h;
        const [d, c, u, p] = this.#Mn();
        if (isNaN(i[6]) && !this.isEmpty()) {
            const t = new Float64Array(36);
            t.set([NaN, NaN, NaN, NaN, (i[2] - a) / o, (i[3] - r) / h, NaN, NaN, NaN, NaN, (i[4] - a) / o, (i[5] - r) / h, NaN, NaN, NaN, NaN, d, c, NaN, NaN, NaN, NaN, u, p, NaN, NaN, NaN, NaN, (i[16] - a) / o, (i[17] - r) / h, NaN, NaN, NaN, NaN, (i[14] - a) / o, (i[15] - r) / h], 0);
            return new FreeHighlightOutline(t, l, this.#nn, this.#xn, this.#gn, this.#mn)
        }
        const g = new Float64Array(this.#fn.length + 24 + this.#pn.length);
        let m = t.length;
        for (let e = 0; e < m; e += 2) if (isNaN(t[e])) g[e] = g[e + 1] = NaN; else {
            g[e] = t[e];
            g[e + 1] = t[e + 1]
        }
        g.set([NaN, NaN, NaN, NaN, (s[0] - a) / o, (s[1] - r) / h, NaN, NaN, NaN, NaN, d, c, NaN, NaN, NaN, NaN, u, p, NaN, NaN, NaN, NaN, (n[0] - a) / o, (n[1] - r) / h], m);
        m += 24;
        ...
        return new FreeHighlightOutline(g, l, this.#nn, this.#xn, this.#gn, this.#mn)
    }
}
...
class FreeHighlightOutline extends Outline {
    ...
    constructor(t, e, i, s, n, a) {
        ...
        this.#mn = a;
        this.#Dn(a);
        const {x: r, y: o, width: h, height: l} = this.#kn;
    ...
    toSVGPath() {
        const t = [`M${this.#Pn[4]} ${this.#Pn[5]}`];
        for (let e = 6, i = this.#Pn.length; e < i; e += 6) isNaN(this.#Pn[e]) ? t.push(`L${this.#Pn[e + 4]} ${this.#Pn[e + 5]}`) : t.push(`C${this.#Pn[e]} ${this.#Pn[e + 1]} ${this.#Pn[e + 2]} ${this.#Pn[e + 3]} ${this.#Pn[e + 4]} ${this.#Pn[e + 5]}`);
        t.push("Z");
        return t.join(" ")
    }
    ...
    serialize([t, e, i, s], n) {
        ...
        switch (n) {
            case 0:
                o = this.#Rn(this.#Pn, t, s, a, -r);
                h = this.#Rn(this.#_n, t, s, a, -r);
                break;
            case 90:
                o = this.#Fn(this.#Pn, t, e, a, r);
                h = this.#Fn(this.#_n, t, e, a, r);
                break;
            case 180:
                o = this.#Rn(this.#Pn, i, e, -a, r);
                h = this.#Rn(this.#_n, i, e, -a, r);
                break;
            case 270:
                o = this.#Fn(this.#Pn, i, s, -a, -r);
                h = this.#Fn(this.#_n, i, s, -a, -r)
        }
    ...
    #Dn(t) {
        const e = this.#Pn;
        let i = e[4], s = e[5], n = i, a = s, r = i, o = s, h = i, l = s;
        ...
        for (let t = 6, c = e.length; t < c; t += 6) {
            if (isNaN(e[t])) {
                ...
                if (l < c[3]) {
                    h = c[2];
                    l = c[3]
                } else l === c[3] && (h = d(h, c[2]))
            }
            i = e[t + 4];
            s = e[t + 5]
        }
        const c = n - this.#gn, u = a - this.#gn, p = r - n + 2 * this.#gn, g = o - a + 2 * this.#gn;
        this.#kn = {x: c, y: u, width: p, height: g, lastPoint: [h, l]}
    }
    ...
    getNewOutline(t, e) {
        const {x: i, y: s, width: n, height: a} = this.#kn, [r, o, h, l] = this.#nn, d = n * h, c = a * l,
            u = i * h + r, p = s * l + o, g = new FreeOutliner({
                x: this.#_n[0] * d + u,
                y: this.#_n[1] * c + p
            }, this.#nn, this.#xn, t, this.#mn, e ?? this.#gn);
        for (let t = 2; t < this.#_n.length; t += 2) g.add({x: this.#_n[t] * d + u, y: this.#_n[t + 1] * c + p});
...
class ColorPicker {
    ...
    constructor({editor: t = null, uiManager: e = null}) {
        ...
        this.#Un = this.#u._eventBus;
        this.#Nn = t?.color || this.#u?.highlightColors.values().next().value || "#FFFF98"
    }

    renderButton() {
        const t = this.#Ln = document.createElement("button");
        ...
        t.addEventListener("keydown", this.#ns);
        const e = this.#On = document.createElement("span");
        e.className = "swatch";
        e.setAttribute("aria-hidden", !0);
        e.style.backgroundColor = this.#Nn;
        t.append(e);
        return t
    }

    renderMainDropdown() {
        const t = this.#Bn = this.#Vn();
    ...
    #Vn() {
        ...
        for (const [e, i] of this.#u.highlightColors) {
            ...
            s.setAttribute("aria-selected", i === this.#Nn);
    ...
    #Gn(t, e) {
        e.stopPropagation();
        this.#Un.dispatch("switchannotationeditorparams", {source: this, type: this.#jn, value: t})
    }
    ...
    _moveToNext(t) {
        this.#Wn ? t.target !== this.#Ln ? t.target.nextSibling?.focus() : this.#Bn.firstChild?.focus() : this.#$n(t)
    }

    _moveToPrevious(t) {
        if (t.target !== this.#Bn?.firstChild && t.target !== this.#Ln) {
            this.#Wn || this.#$n(t);
            t.target.previousSibling?.focus()
        } else this.#Wn && this._hideDropdownFromKeyboard()
    }

    _moveToBeginning(t) {
        this.#Wn ? this.#Bn.firstChild?.focus() : this.#$n(t)
    }

    _moveToEnd(t) {
        this.#Wn ? this.#Bn.lastChild?.focus() : this.#$n(t)
    }
    ...
    #$n(t) {
        ...
        this.#Hn = 0 === t.detail;
        window.addEventListener("pointerdown", this.#In);
        if (this.#Bn) {
            this.#Bn.classList.remove("hidden");
            return
        }
        const e = this.#Bn = this.#Vn();
        this.#Ln.append(e)
    }

    #r(t) {
        this.#Bn?.contains(t.target) || this.hideDropdown()
    }

    hideDropdown() {
        this.#Bn?.classList.add("hidden");
        window.removeEventListener("pointerdown", this.#In)
    }

    get #Wn() {
        return this.#Bn && !this.#Bn.classList.contains("hidden")
    }

    _hideDropdownFromKeyboard() {
        if (!this.#zn) if (this.#Wn) {
            this.hideDropdown();
            this.#Ln.focus({preventScroll: !0, focusVisible: this.#Hn})
        } else this.#n?.unselect()
    }

    updateColor(t) {
        this.#On && (this.#On.style.backgroundColor = t);
        if (!this.#Bn) return;
        const e = this.#u.highlightColors.values();
        for (const i of this.#Bn.children) i.setAttribute("aria-selected", e.next().value === t)
    }
...
class HighlightEditor extends AnnotationEditor {
    ...
    static get _keyboardManager() {
        ...
        return shadow(this, "_keyboardManager", new KeyboardManager([[["ArrowLeft", "mac+ArrowLeft"], t._moveCaret, {args: [0]}], [["ArrowRight", "mac+ArrowRight"], t._moveCaret, {args: [1]}], [["ArrowUp", "mac+ArrowUp"], t._moveCaret, {args: [2]}], [["ArrowDown", "mac+ArrowDown"], t._moveCaret, {args: [3]}]]))
    }

    constructor(t) {
        super({...t, name: "highlightEditor"});
        this.color = t.color || HighlightEditor._defaultColor;
        this.#En = t.thickness || HighlightEditor._defaultThickness;
        this.#aa = t.opacity || HighlightEditor._defaultOpacity;
        this.#Kn = t.boxes || null;
        ...
        if (t.highlightId > -1) {
            ...
            this.#qn = t.anchorNode;
            this.#Xn = t.anchorOffset;
            this.#Jn = t.focusNode;
            this.#Zn = t.focusOffset;
            this.#ca();
            this.#da();
    ...
    get telemetryInitialData() {
        return {
            action: "added",
            type: this.#ia ? "free_highlight" : "highlight",
    ...
    #ca() {
        const t = new Outliner(this.#Kn, .001);
        this.#ea = t.getOutlines();
        ({x: this.x, y: this.y, width: this.width, height: this.height} = this.#ea.box);
        const e = new Outliner(this.#Kn, .0025, .001, "ltr" === this._uiManager.direction);
        this.#Qn = e.getOutlines();
        const {lastPoint: i} = this.#Qn.box;
        this.#na = [(i[0] - this.x) / this.width, (i[1] - this.y) / this.height]
    }

    #la({highlightOutlines: t, highlightId: e, clipPathId: i}) {
        this.#ea = t;
        this.#Qn = t.getNewOutline(this.#En / 2 + 1.5, .0025);
        if (e >= 0) {
            this.#f = e;
            this.#Yn = i;
            this.parent.drawLayer.finalizeLine(e, t);
            this.#ra = this.parent.drawLayer.highlightOutline(this.#Qn)
        } else if (this.parent) {
            const e = this.parent.viewport.rotation;
            this.parent.drawLayer.updateLine(this.#f, t);
            this.parent.drawLayer.updateBox(this.#f, HighlightEditor.#ua(this.#ea.box, (e - this.rotation + 360) % 360));
            this.parent.drawLayer.updateLine(this.#ra, this.#Qn);
            this.parent.drawLayer.updateBox(this.#ra, HighlightEditor.#ua(this.#Qn.box, e))
        }
        ...
        const {lastPoint: o} = this.#Qn.box;
        this.#na = [(o[0] - s) / a, (o[1] - n) / r]
    }
    ...
    static get defaultPropertiesToUpdate() {
        return [[g.HIGHLIGHT_DEFAULT_COLOR, HighlightEditor._defaultColor], [g.HIGHLIGHT_THICKNESS, HighlightEditor._defaultThickness]]
    }

    get propertiesToUpdate() {
        return [[g.HIGHLIGHT_COLOR, this.color || HighlightEditor._defaultColor], [g.HIGHLIGHT_THICKNESS, this.#En || HighlightEditor._defaultThickness], [g.HIGHLIGHT_FREE, this.#ia]]
    }
    ...
    #pa(t) {
        const e = this.#En, setThickness = t => {
            this.#En = t;
            this.#ga(t)
        };
        this.addCommands({
    ...
    fixAndSetPosition() {
        return super.fixAndSetPosition(this.#ma())
    }
    ...
    getRect(t, e) {
        return super.getRect(t, e, this.#ma())
    }
    ...
    setParent(t) {
        let e = !1;
        if (this.parent && !t) this.#fa(); else if (t) {
            this.#da(t);
    ...
    #ga(t) {
        if (!this.#ia) return;
        this.#la({highlightOutlines: this.#ea.getNewOutline(t / 2)});
        this.fixAndSetPosition();
    ...
    #fa() {
        if (null !== this.#f && this.parent) {
            ...
            this.#f = null;
            this.parent.drawLayer.remove(this.#ra);
            this.#ra = null
        }
    }
    ...
    #da(t = this.parent) {
        if (null === this.#f) {
            ({id: this.#f, clipPathId: this.#Yn} = t.drawLayer.highlight(this.#ea, this.color, this.#aa));
            this.#ra = t.drawLayer.highlightOutline(this.#Qn);
            this.#ta && (this.#ta.style.clipPath = this.#Yn)
        }
    }

    static #ua({x: t, y: e, width: i, height: s}, n) {
        switch (n) {
            case 90:
    ...
    rotate(t) {
        ...
        if (this.#ia) {
            ...
            i = HighlightEditor.#ua(this.#ea.box, t)
        } else i = HighlightEditor.#ua(this, t);
        e.rotate(this.#f, t);
        e.rotate(this.#ra, t);
        e.updateBox(this.#f, i);
        e.updateBox(this.#ra, HighlightEditor.#ua(this.#Qn.box, t))
    }
    ...
    render() {
        ...
        const t = super.render();
        if (this.#oa) {
            t.setAttribute("aria-label", this.#oa);
            t.setAttribute("role", "mark")
        }
        this.#ia ? t.classList.add("free") : this.div.addEventListener("keydown", this.#at);
        const e = this.#ta = document.createElement("div");
        t.append(e);
        e.setAttribute("aria-hidden", "true");
        e.className = "internal";
        e.style.clipPath = this.#Yn;
        const [i, s] = this.parentDimensions;
        this.setDims(this.width * i, this.height * s);
        bindEvents(this, this.#ta, ["pointerover", "pointerleave"]);
        this.enableEditing();
        return t
    }

    pointerover() {
        this.parent.drawLayer.addClass(this.#ra, "hovered")
    }

    pointerleave() {
        this.parent.drawLayer.removeClass(this.#ra, "hovered")
    }
    ...
    #ba(t) {
        ...
        t ? e.setPosition(this.#qn, this.#Xn) : e.setPosition(this.#Jn, this.#Zn)
    }
    ...
    select() {
        ...
        if (this.#ra) {
            this.parent?.drawLayer.removeClass(this.#ra, "hovered");
            this.parent?.drawLayer.addClass(this.#ra, "selected")
        }
    }
    ...
    unselect() {
        super.unselect();
        if (this.#ra) {
            this.parent?.drawLayer.removeClass(this.#ra, "selected");
            this.#ia || this.#ba(!1)
        }
    }
    ...
    show(t = this._isVisible) {
        ...
        if (this.parent) {
            ...
            this.parent.drawLayer.show(this.#ra, t)
        }
    }

    #ma() {
        return this.#ia ? this.rotation : 0
    }

    #va() {
        if (this.#ia) return null;
        const [t, e] = this.pageDimensions, i = this.#Kn, s = new Array(8 * i.length);
        let n = 0;
        for (const {x: a, y: r, width: o, height: h} of i) {
            const i = a * t, l = (1 - r - h) * e;
            s[n] = s[n + 4] = i;
            s[n + 1] = s[n + 3] = l;
            s[n + 2] = s[n + 6] = i + o * t;
            s[n + 5] = s[n + 7] = l + h * e;
    ...
    #Aa(t) {
        return this.#ea.serialize(t, this.#ma())
    }

    static startHighlighting(t, e, {target: i, x: s, y: n}) {
        const {x: a, y: r, width: o, height: h} = i.getBoundingClientRect(), pointerMove = e => {
            this.#ya(t, e)
        }, l = {capture: !0, passive: !1}, pointerDown = t => {
            t.preventDefault();
            t.stopPropagation()
        }, pointerUpCallback = e => {
            ...
            window.removeEventListener("blur", pointerUpCallback);
            window.removeEventListener("pointerup", pointerUpCallback);
            window.removeEventListener("pointerdown", pointerDown, l);
            window.removeEventListener("contextmenu", noContextMenu);
            this.#wa(t, e)
        };
        window.addEventListener("blur", pointerUpCallback);
        window.addEventListener("pointerup", pointerUpCallback);
        window.addEventListener("pointerdown", pointerDown, l);
        window.addEventListener("contextmenu", noContextMenu);
        i.addEventListener("pointermove", pointerMove);
        this._freeHighlight = new FreeOutliner({
            x: s,
            y: n
        }, [a, r, o, h], t.scale, this._defaultThickness / 2, e, .001);
        ({
    ...
    static deserialize(t, e, i) {
        const s = super.deserialize(t, e, i), {rect: [n, a, r, o], color: h, quadPoints: l} = t;
        s.color = Util.makeHexColor(...h);
        s.#aa = t.opacity;
        const [d, c] = s.pageDimensions;
        s.width = (r - n) / d;
        s.height = (o - a) / c;
        const u = s.#Kn = [];
        for (let t = 0; t < l.length; t += 8) u.push({
            x: (l[4] - r) / d,
            y: (o - (1 - l[t + 5])) / c,
            width: (l[t + 2] - l[t]) / d,
            height: (l[t + 5] - l[t + 1]) / c
        });
        s.#ca();
        return s
    }
...
class InkEditor extends AnnotationEditor {
    #xa = 0;
    #Ea = 0;
    #_a = this.canvasPointermove.bind(this);
    #Ca = this.canvasPointerleave.bind(this);
    #Sa = this.canvasPointerup.bind(this);
    #Ta = this.canvasPointerdown.bind(this);
    #Ma = null;
    #ka = new Path2D;
    #Pa = !1;
    #Da = !1;
    ...
    static get defaultPropertiesToUpdate() {
        return [[g.INK_THICKNESS, InkEditor._defaultThickness], [g.INK_COLOR, InkEditor._defaultColor || AnnotationEditor._defaultLineColor], [g.INK_OPACITY, Math.round(100 * InkEditor._defaultOpacity)]]
    }

    get propertiesToUpdate() {
        return [[g.INK_THICKNESS, this.thickness || InkEditor._defaultThickness], [g.INK_COLOR, this.color || InkEditor._defaultColor || AnnotationEditor._defaultLineColor], [g.INK_OPACITY, Math.round(100 * (this.opacity ?? InkEditor._defaultOpacity))]]
    }
    ...
    enableEditMode() {
        if (!this.#Pa && null !== this.canvas) {
            super.enableEditMode();
            this._isDraggable = !1;
            this.canvas.addEventListener("pointerdown", this.#Ta)
        }
    }
    ...
    disableEditMode() {
        if (this.isInEditMode() && null !== this.canvas) {
            ...
            this.canvas.removeEventListener("pointerdown", this.#Ta)
        }
    }
    ...
    #Ga(t, e) {
        ...
        this.canvas.addEventListener("pointerleave", this.#Ca);
        this.canvas.addEventListener("pointermove", this.#_a);
        this.canvas.addEventListener("pointerup", this.#Sa);
        this.canvas.removeEventListener("pointerdown", this.#Ta);
        this.isEditing = !0;
        if (!this.#Ra) {
            this.#Ra = !0;
        ...
        this.#Oa = () => {
            this.#Wa();
            this.#Oa && window.requestAnimationFrame(this.#Oa)
        };
        window.requestAnimationFrame(this.#Oa)
    }
    ...
    #qa(t, e) {
        ...
        if (n.length <= 2) {
            ...
            if (3 === n.length) {
                this.#ka = a = new Path2D;
                a.moveTo(...n[0])
            }
            this.#Xa(a, ...n.at(-3), ...n.at(-2), t, e)
        }
    }
    ...
    #Ya(t, e) {
        ...
        this.#Ka();
        let i;
        if (1 !== this.currentPath.length) i = this.#Qa(); else {
            const s = [t, e];
            i = [[s, s.slice(), s.slice(), s]]
        }
        const s = this.#ka, n = this.currentPath;
        this.currentPath = [];
        this.#ka = new Path2D;
        this.addCommands({
            cmd: () => {
    ...
    #Wa() {
        if (!this.#Da) return;
        this.#Da = !1;
        const t = Math.ceil(this.thickness * this.parentScale), e = this.currentPath.slice(-3), i = e.map((t => t[0])),
            s = e.map((t => t[1])), {ctx: n} = (Math.min(...i), Math.max(...i), Math.min(...s), Math.max(...s), this);
        n.save();
    ...
    #Xa(t, e, i, s, n, a, r) {
        const o = (e + s) / 2, h = (i + n) / 2, l = (s + a) / 2, d = (n + r) / 2;
        t.bezierCurveTo(o + 2 * (s - o) / 3, h + 2 * (n - h) / 3, l + 2 * (s - l) / 3, d + 2 * (n - d) / 3, l, d)
    }
    ...
    #Qa() {
        ...
        for (i = 1; i < t.length - 2; i++) {
            const [a, r] = t[i], [o, h] = t[i + 1], l = (a + o) / 2, d = (r + h) / 2,
                c = [s + 2 * (a - s) / 3, n + 2 * (r - n) / 3], u = [l + 2 * (a - l) / 3, d + 2 * (r - d) / 3];
            e.push([[s, n], c, u, [l, d]]);
            [s, n] = [l, d]
        }
        const [a, r] = t[i], [o, h] = t[i + 1], l = [s + 2 * (a - s) / 3, n + 2 * (r - n) / 3],
            d = [o + 2 * (a - o) / 3, h + 2 * (r - h) / 3];
        e.push([[s, n], l, d, [o, h]]);
        return e
    }
    ...
    canvasPointerdown(t) {
        if (0 === t.button && this.isInEditMode() && !this.#Pa) {
            this.setInForeground();
            t.preventDefault();
    ...
    #Za(t) {
        this.canvas.removeEventListener("pointerleave", this.#Ca);
        this.canvas.removeEventListener("pointermove", this.#_a);
        this.canvas.removeEventListener("pointerup", this.#Sa);
        this.canvas.addEventListener("pointerdown", this.#Ta);
        this.#Ma && clearTimeout(this.#Ma);
        this.#Ma = setTimeout((() => {
            this.#Ma = null;
            this.canvas.removeEventListener("contextmenu", noContextMenu)
        }), 10);
        this.#Ya(t.offsetX, t.offsetY);
        this.addToAnnotationStorage();
    ...
    #Ua() {
        this.#Fa = new ResizeObserver((t => {
            const e = t[0].contentRect;
            e.width && e.height && this.setDimensions(e.width, e.height)
        }));
        this.#Fa.observe(this.div)
    }

    get isResizable() {
        return !this.isEmpty() && this.#Pa
    }
    ...
    #tr(t, e) {
        const i = this.#er(), s = (t - i) / this.#Ea, n = (e - i) / this.#xa;
    ...
    #ar(t, e, i, s) {
        ...
        for (const e of this.paths) {
            ...
            for (let s = 0, n = e.length; s < n; s++) {
                const [h, l, d, c] = e[s];
                if (h[0] === c[0] && h[1] === c[1] && 1 === n) {
                    const e = t * h[0] + r, s = t * h[1] + o;
                    i.push(e, s);
                    a.push(e, s);
                    break
                }
                const u = t * h[0] + r, p = t * h[1] + o, g = t * l[0] + r, m = t * l[1] + o, f = t * d[0] + r,
                    b = t * d[1] + o, v = t * c[0] + r, A = t * c[1] + o;
                if (0 === s) {
                    i.push(u, p);
                    a.push(u, p)
                }
            ...
            n.push({bezier: InkEditor.#sr(i, s, this.rotation), points: InkEditor.#sr(a, s, this.rotation)})
        }
        return n
    }
    ...
    #rr() {
        ...
        for (const n of this.paths) for (const [a, r, o, h] of n) {
            const n = Util.bezierBoundingBox(...a, ...r, ...o, ...h);
            t = Math.min(t, n[0]);
            i = Math.min(i, n[1]);
            e = Math.max(e, n[2]);
            s = Math.max(s, n[3])
    ...
    #er() {
        return this.#Pa ? Math.ceil(this.thickness * this.parentScale) : 0
    }
    ...
    #Ba(t = !1) {
        ...
        const e = this.#rr(), i = this.#er();
        this.#Ea = Math.max(AnnotationEditor.MIN_SIZE, e[2] - e[0]);
        this.#xa = Math.max(AnnotationEditor.MIN_SIZE, e[3] - e[1]);
        const s = Math.ceil(i + this.#Ea * this.scaleFactor),
            n = Math.ceil(i + this.#xa * this.scaleFactor), [a, r] = this.parentDimensions;
        this.width = s / a;
        this.height = n / r;
        this.setAspectRatio(s, n);
        const o = this.translationX, h = this.translationY;
    ...
    static deserialize(t, e, i) {
        ...
        s.opacity = t.opacity;
        const [n, a] = s.pageDimensions, r = s.width * n, o = s.height * a, h = s.parentScale, l = t.thickness / 2;
        s.#Pa = !0;
        s.#Ia = Math.round(r);
        s.#La = Math.round(o);
        const {paths: d, rect: c, rotation: u} = t;
        for (let {bezier: t} of d) {
            t = InkEditor.#nr(t, c, u);
            const e = [];
            s.paths.push(e);
            let i = h * (t[0] - l), n = h * (t[1] - l);
            for (let s = 2, a = t.length; s < a; s += 6) {
                const a = h * (t[s] - l), r = h * (t[s + 1] - l), o = h * (t[s + 2] - l), d = h * (t[s + 3] - l),
                    c = h * (t[s + 4] - l), u = h * (t[s + 5] - l);
                e.push([[i, n], [a, r], [o, d], [c, u]]);
                i = c;
                n = u
            }
            const a = this.#ir(e);
        ...
        const p = s.#rr();
        s.#Ea = Math.max(AnnotationEditor.MIN_SIZE, p[2] - p[0]);
        s.#xa = Math.max(AnnotationEditor.MIN_SIZE, p[3] - p[1]);
        s.#tr(r, o);
        return s
    }
    ...
    serialize() {
        ...
        return {
            ...
            paths: this.#ar(this.scaleFactor / this.parentScale, this.translationX, this.translationY, t),
            pageIndex: this.pageIndex,
            rect: t,
            rotation: this.rotation,
            structTreeParentId: this._structTreeParentId
...
class StampEditor extends AnnotationEditor {
    ...
    static get supportedTypes() {
        return shadow(this, "supportedTypes", ["apng", "avif", "bmp", "gif", "jpeg", "png", "svg+xml", "webp", "x-icon"].map((t => `image/${t}`)))
    }
    ...
    #vr() {
        ...
        this.#pr && this.div.focus()
    }

    #Ar() {
        if (this.#hr) {
            this._uiManager.enableWaiting(!0);
            this._uiManager.imageManager.getFromId(this.#hr).then((t => this.#br(t, !0))).finally((() => this.#vr()));
            return
        }
        if (this.#dr) {
            const t = this.#dr;
            this.#dr = null;
            this._uiManager.enableWaiting(!0);
            this.#lr = this._uiManager.imageManager.getFromUrl(t).then((t => this.#br(t))).finally((() => this.#vr()));
            return
        }
        if (this.#cr) {
            const t = this.#cr;
            this.#cr = null;
            this._uiManager.enableWaiting(!0);
            this.#lr = this._uiManager.imageManager.getFromFile(t).then((t => this.#br(t))).finally((() => this.#vr()));
            return
        }
        const t = document.createElement("input");
        t.type = "file";
        t.accept = StampEditor.supportedTypesStr;
        this.#lr = new Promise((e => {
    ...
    rebuild() {
        if (this.parent) {
            super.rebuild();
            if (null !== this.div) {
                this.#hr && null === this.#pr && this.#Ar();
                this.isAttachedToDOM || this.parent.add(this)
            }
        } else this.#hr && this.#Ar()
    }
    ...
    isEmpty() {
        return !(this.#lr || this.#or || this.#dr || this.#cr || this.#hr)
    }
    ...
    #za() {
        ...
        this._uiManager.enableWaiting(!1);
        const h = this.#pr = document.createElement("canvas");
        t.append(h);
        t.hidden = !1;
        this.#yr(e, i);
        this.#Ua();
        ...
        this.#ur && h.setAttribute("aria-label", this.#ur)
    }
    ...
    #wr(t, e) {
        ...
        this._initialOptions = null;
        null !== this.#gr && clearTimeout(this.#gr);
        this.#gr = setTimeout((() => {
            this.#gr = null;
            this.#yr(t, e)
        }), 200)
    ...
    #xr(t, e) {
        const {width: i, height: s} = this.#or;
        let n = i, a = s, r = this.#or;
        for (; n > 2 * t || a > 2 * e;) {
            const i = n, s = a;
    ...
    #yr(t, e) {
        ...
        i.width = t;
        i.height = e;
        const s = this.#mr ? this.#or : this.#xr(t, e);
    ...
    #Er(t) {
        if (t) {
            ...
            ({width: t.width, height: t.height} = this.#or);
            t.getContext("2d").drawImage(this.#or, 0, 0);
            return t.toDataURL()
        }
        if (this.#mr) {
            const [t, e] = this.pageDimensions, i = Math.round(this.width * t * PixelsPerInch.PDF_TO_CSS_UNITS),
                s = Math.round(this.height * e * PixelsPerInch.PDF_TO_CSS_UNITS), n = new OffscreenCanvas(i, s);
            n.getContext("2d").drawImage(this.#or, 0, 0, this.#or.width, this.#or.height, 0, 0, i, s);
            return n.transferToImageBitmap()
        }
        return structuredClone(this.#or)
    }

    #Ua() {
        this.#Fa = new ResizeObserver((t => {
            const e = t[0].contentRect;
            e.width && e.height && this.#wr(e.width, e.height)
        }));
        this.#Fa.observe(this.div)
    }
    ...
    static deserialize(t, e, i) {
        ...
        const s = super.deserialize(t, e, i), {rect: n, bitmapUrl: a, bitmapId: r, isSvg: o, accessibilityData: h} = t;
        r && i.imageManager.isValidId(r) ? s.#hr = r : s.#dr = a;
        s.#mr = o;
        const [l, d] = s.pageDimensions;
        s.width = (n[2] - n[0]) / l;
        s.height = (n[3] - n[1]) / d;
        h && (s.altTextData = h);
        return s
    ...
    serialize(t = !1, e = null) {
        ...
        if (null === e) return i;
        e.stamps ||= new Map;
        const a = this.#mr ? (i.rect[2] - i.rect[0]) * (i.rect[3] - i.rect[1]) : null;
...
class AnnotationEditorLayer {
    ...
    static#L = new Map([FreeTextEditor, InkEditor, StampEditor, HighlightEditor].map((t => [t._editorType, t])));
    ...
    constructor({
        ...
        const l = [...AnnotationEditorLayer.#L.values()];
        if (!AnnotationEditorLayer._initialized) {
            AnnotationEditorLayer._initialized = !0;
            for (const e of l) e.initialize(h, t)
        }
        t.registerEditorTypes(l);
        this.#u = t;
        this.pageIndex = e;
        this.div = i;
        this.#Os = s;
    ...
    updateMode(t = this.#u.getMode()) {
        ...
        for (const i of AnnotationEditorLayer.#L.values()) e.toggle(`${i._type}Editing`, t === i._editorType);
        this.div.hidden = !1
    }

    hasTextLayer(t) {
        return t === this.#Ir?.div
    }

    addInkEditorIfNeeded(t) {
        if (this.#u.getMode() !== p.INK) return;
        if (!t) for (const t of this.#Pr.values()) if (t.isEmpty()) {
            t.setInBackground();
            return
        }
    ...
    toggleAnnotationLayerPointerEvents(t = !1) {
        this.#Cr?.div.classList.toggle("disabled", !t)
    }
    ...
    enable() {
        ...
        if (!this.#Cr) return;
        const e = this.#Cr.getEditableAnnotations();
        for (const i of e) {
            i.hide();
    ...
    disable() {
        ...
        if (this.#Cr) {
            const i = this.#Cr.getEditableAnnotations();
            for (const s of i) {
                const {id: i} = s.data;
        ...
        for (const t of AnnotationEditorLayer.#L.values()) i.remove(`${t._type}Editing`);
        this.disableTextSelection();
        this.toggleAnnotationLayerPointerEvents(!0);
        this.#Fr = !1
    }
    ...
    getEditableAnnotation(t) {
        return this.#Cr?.getEditableAnnotation(t) || null
    }
    ...
    enableTextSelection() {
        this.div.tabIndex = -1;
        if (this.#Ir?.div && !this.#Mr) {
            this.#Mr = this.#Or.bind(this);
            this.#Ir.div.addEventListener("pointerdown", this.#Mr);
            this.#Ir.div.classList.add("highlighting")
        }
    }
    ...
    disableTextSelection() {
        this.div.tabIndex = 0;
        if (this.#Ir?.div && this.#Mr) {
            this.#Ir.div.removeEventListener("pointerdown", this.#Mr);
            this.#Mr = null;
            this.#Ir.div.classList.remove("highlighting")
        }
    }

    #Or(t) {
        this.#u.unselectAll();
        if (t.target === this.#Ir.div) {
            const {isMac: e} = util_FeatureTest.platform;
            if (0 !== t.button || t.ctrlKey && e) return;
            this.#u.showAllEditors("highlight", !0, !0);
            this.#Ir.div.classList.add("free");
            HighlightEditor.startHighlighting(this, "ltr" === this.#u.direction, t);
            this.#Ir.div.addEventListener("pointerup", (() => {
                this.#Ir.div.classList.remove("free")
            }), {once: !0});
            t.preventDefault()
        }
    }
    ...
    enableClick() {
        if (!this.#Tr) {
            this.#Tr = this.pointerdown.bind(this);
            this.#Sr = this.pointerup.bind(this);
            this.div.addEventListener("pointerdown", this.#Tr);
            this.div.addEventListener("pointerup", this.#Sr)
        }
    }

    disableClick() {
        if (this.#Tr) {
            this.div.removeEventListener("pointerdown", this.#Tr);
            this.div.removeEventListener("pointerup", this.#Sr);
            this.#Tr = null;
            this.#Sr = null
        }
    }
    ...
    attach(t) {
        ...
        e && this.#u.isDeletedAnnotationElement(e) && this.#u.removeDeletedAnnotationElement(t)
    }

    detach(t) {
        this.#Pr.delete(t.id);
        this.#Os?.removePointerInTextLayer(t.contentDiv);
        !this.#Fr && t.annotationElementId && this.#u.addDeletedAnnotationElement(t)
    }
    ...
    moveEditorInDOM(t) {
        ...
        t._structTreeParentId = this.#Os?.moveElementInDOM(this.div, t.div, t.contentDiv, !0)
    }
    ...
    canCreateNewEmptyEditor() {
        return this.#Nr?.canCreateNewEmptyEditor()
    }

    pasteEditor(t, e) {
        this.#u.updateToolbar(t);
        this.#u.updateMode(t);
        const {offsetX: i, offsetY: s} = this.#Hr(), n = this.getNextId(),
            a = this.#Br({parent: this, id: n, x: i, y: s, uiManager: this.#u, isCentered: !0, ...e});
        a && this.add(a)
    }

    deserialize(t) {
        return AnnotationEditorLayer.#L.get(t.annotationType ?? t.annotationEditorType)?.deserialize(t, this, this.#u) || null
    }

    createAndAddNewEditor(t, e, i = {}) {
        const s = this.getNextId(),
            n = this.#Br({parent: this, id: s, x: t.offsetX, y: t.offsetY, uiManager: this.#u, isCentered: e, ...i});
        n && this.add(n);
        return n
    }

    #Hr() {
        const {x: t, y: e, width: i, height: s} = this.div.getBoundingClientRect(), n = Math.max(0, t),
            a = Math.max(0, e), r = (n + Math.min(window.innerWidth, t + i)) / 2 - t,
            o = (a + Math.min(window.innerHeight, e + s)) / 2 - e, [h, l] = this.viewport.rotation % 180 == 0 ? [r, o] : [o, r];
        return {offsetX: h, offsetY: l}
    }

    addNewEditor() {
        this.createAndAddNewEditor(this.#Hr(), !0)
    }
    ...
    pointerup(t) {
        const {isMac: e} = util_FeatureTest.platform;
        if (!(0 !== t.button || t.ctrlKey && e) && t.target === this.div && this.#Dr) {
            this.#Dr = !1;
            this.#_r ? this.#u.getMode() !== p.STAMP ? this.createAndAddNewEditor(t, !1) : this.#u.unselectAll() : this.#_r = !0
        }
    }
    ...
    #Lr() {
        this.#Rr = !0;
        for (const t of this.#Pr.values()) t.isEmpty() && t.remove();
        this.#Rr = !1
    }
    ...
    update({viewport: t}) {
        ...
        if (e !== i) for (const t of this.#Pr.values()) t.rotate(i);
        this.addInkEditorIfNeeded(!1)
    }
...
class DrawLayer {
    ...
    setParent(t) {
        if (this.#fs) {
            if (this.#fs !== t) {
                if (this.#zr.size > 0) for (const e of this.#zr.values()) {
                    e.remove();
                    t.append(e)
                }
                this.#fs = t
    ...
    highlight(t, e, i, s = !1) {
        ...
        s && this.#Ur.set(n, o);
        const l = this.#Vr(r, h), d = DrawLayer._svgFactory.createElement("use");
        a.append(d);
    ...
    updatePath(t, e) {
        this.#Ur.get(t).setAttribute("d", e.toSVGPath())
    }
...
var te = __webpack_exports__.AbortException, ee = __webpack_exports__.AnnotationEditorLayer,
    ie = __webpack_exports__.AnnotationEditorParamsType, se = __webpack_exports__.AnnotationEditorType,
    ne = __webpack_exports__.AnnotationEditorUIManager, ae = __webpack_exports__.AnnotationLayer,
    re = __webpack_exports__.AnnotationMode, oe = __webpack_exports__.CMapCompressionType,
    he = __webpack_exports__.ColorPicker, le = __webpack_exports__.DOMSVGFactory, de = __webpack_exports__.DrawLayer,
    ce = __webpack_exports__.FeatureTest, ue = __webpack_exports__.GlobalWorkerOptions,
    pe = __webpack_exports__.ImageKind, ge = __webpack_exports__.InvalidPDFException,
    me = __webpack_exports__.MissingPDFException, fe = __webpack_exports__.OPS, be = __webpack_exports__.Outliner,
    ve = __webpack_exports__.PDFDataRangeTransport, Ae = __webpack_exports__.PDFDateString,
    ye = __webpack_exports__.PDFWorker, we = __webpack_exports__.PasswordResponses,
    xe = __webpack_exports__.PermissionFlag, Ee = __webpack_exports__.PixelsPerInch,
    _e = __webpack_exports__.RenderingCancelledException, Ce = __webpack_exports__.TextLayer,
    Se = __webpack_exports__.UnexpectedResponseException, Te = __webpack_exports__.Util,
    Me = __webpack_exports__.VerbosityLevel, ke = __webpack_exports__.XfaLayer, Pe = __webpack_exports__.build,
    De = __webpack_exports__.createValidAbsoluteUrl, Re = __webpack_exports__.fetchData,
    Fe = __webpack_exports__.getDocument, Ie = __webpack_exports__.getFilenameFromUrl,
    Le = __webpack_exports__.getPdfFilenameFromUrl, Oe = __webpack_exports__.getXfaPageViewport,
    Ne = __webpack_exports__.isDataScheme, Be = __webpack_exports__.isPdfFile, He = __webpack_exports__.noContextMenu,
    ze = __webpack_exports__.normalizeUnicode, Ue = __webpack_exports__.renderTextLayer,
    je = __webpack_exports__.setLayerDimensions, $e = __webpack_exports__.shadow,
    Ve = __webpack_exports__.updateTextLayer, Ge = __webpack_exports__.version;
export {
